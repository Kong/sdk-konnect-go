...
func (s *SystemAccountsAccessTokens) PostSystemAccountsIDAccessTokens(ctx context.Context, accountID string, createSystemAccountAccessToken *components.CreateSystemAccountAccessToken) (*operations.PostSystemAccountsIDAccessTokensResponse, error) {
