...
// Updates an API.
func (s *API) UpdateAPI(ctx context.Context, apiID string, updateAPIRequest components.UpdateAPIRequest, opts ...operations.Option) (*operations.UpdateAPIResponse, error) {
