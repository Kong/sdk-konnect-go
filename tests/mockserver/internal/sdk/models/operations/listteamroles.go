...
func (o *ListTeamRolesFilter) GetRoleName() *components.StringFieldEqualsFilterUnion {
	if o == nil {
		return nil
	}
	return o.RoleName
...
func (o *ListTeamRolesFilter) GetEntityTypeName() *components.StringFieldEqualsFilterUnion {
	if o == nil {
		return nil
	}
