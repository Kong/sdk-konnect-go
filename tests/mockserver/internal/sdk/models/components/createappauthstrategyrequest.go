...
type AppAuthStrategyKeyAuthRequestStrategyType string

const (
	AppAuthStrategyKeyAuthRequestStrategyTypeKeyAuth AppAuthStrategyKeyAuthRequestStrategyType = "key_auth"
)

func (e AppAuthStrategyKeyAuthRequestStrategyType) ToPointer() *AppAuthStrategyKeyAuthRequestStrategyType {
	return &e
}
func (e *AppAuthStrategyKeyAuthRequestStrategyType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "key_auth":
		*e = AppAuthStrategyKeyAuthRequestStrategyType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AppAuthStrategyKeyAuthRequestStrategyType: %v", v)
	}
}
...
type AppAuthStrategyKeyAuthRequest struct {
	...
	//
	DisplayName  string                                    `json:"display_name"`
	StrategyType AppAuthStrategyKeyAuthRequestStrategyType `json:"strategy_type"`
...
func (o *AppAuthStrategyKeyAuthRequest) GetStrategyType() AppAuthStrategyKeyAuthRequestStrategyType {
	if o == nil {
		return AppAuthStrategyKeyAuthRequestStrategyType("")
	}
	return o.StrategyType
}
...
func CreateCreateAppAuthStrategyRequestKeyAuth(keyAuth AppAuthStrategyKeyAuthRequest) CreateAppAuthStrategyRequest {
	...
	typStr := AppAuthStrategyKeyAuthRequestStrategyType(typ)
