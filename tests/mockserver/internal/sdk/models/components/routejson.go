...
func (o *Destination) GetPort() *int64 {
	if o == nil {
		return nil
	}
	return o.Port
...
// RouteJSONHTTPSRedirectStatusCode - The status code Kong responds with when all properties of a Route match except the protocol i.e. if the protocol of the request is `HTTP` instead of `HTTPS`. `Location` header is injected by Kong if the field is set to 301, 302, 307 or 308. Note: This config applies only if the Route is configured to only accept the `https` protocol.
type RouteJSONHTTPSRedirectStatusCode int64

const (
	RouteJSONHTTPSRedirectStatusCodeFourHundredAndTwentySix RouteJSONHTTPSRedirectStatusCode = 426
	RouteJSONHTTPSRedirectStatusCodeThreeHundredAndOne      RouteJSONHTTPSRedirectStatusCode = 301
	RouteJSONHTTPSRedirectStatusCodeThreeHundredAndTwo      RouteJSONHTTPSRedirectStatusCode = 302
	RouteJSONHTTPSRedirectStatusCodeThreeHundredAndSeven    RouteJSONHTTPSRedirectStatusCode = 307
	RouteJSONHTTPSRedirectStatusCodeThreeHundredAndEight    RouteJSONHTTPSRedirectStatusCode = 308
)

func (e RouteJSONHTTPSRedirectStatusCode) ToPointer() *RouteJSONHTTPSRedirectStatusCode {
	return &e
}
func (e *RouteJSONHTTPSRedirectStatusCode) UnmarshalJSON(data []byte) error {
	var v int64
	...
	case 307:
		fallthrough
	case 308:
		*e = RouteJSONHTTPSRedirectStatusCode(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RouteJSONHTTPSRedirectStatusCode: %v", v)
	}
}

// RouteJSONPathHandling - Controls how the Service path, Route path and requested path are combined when sending a request to the upstream. See above for a detailed description of each behavior.
type RouteJSONPathHandling string

const (
	RouteJSONPathHandlingV0 RouteJSONPathHandling = "v0"
	RouteJSONPathHandlingV1 RouteJSONPathHandling = "v1"
)

func (e RouteJSONPathHandling) ToPointer() *RouteJSONPathHandling {
	return &e
}
func (e *RouteJSONPathHandling) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "v0":
		fallthrough
	case "v1":
		*e = RouteJSONPathHandling(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RouteJSONPathHandling: %v", v)
	}
}
...
const (
	RouteJSONProtocolGrpc           RouteJSONProtocol = "grpc"
	RouteJSONProtocolGrpcs          RouteJSONProtocol = "grpcs"
	RouteJSONProtocolHTTP           RouteJSONProtocol = "http"
	RouteJSONProtocolHTTPS          RouteJSONProtocol = "https"
	RouteJSONProtocolTCP            RouteJSONProtocol = "tcp"
	RouteJSONProtocolTLS            RouteJSONProtocol = "tls"
	RouteJSONProtocolTLSPassthrough RouteJSONProtocol = "tls_passthrough"
	RouteJSONProtocolUDP            RouteJSONProtocol = "udp"
	RouteJSONProtocolWs             RouteJSONProtocol = "ws"
	RouteJSONProtocolWss            RouteJSONProtocol = "wss"
)

func (e RouteJSONProtocol) ToPointer() *RouteJSONProtocol {
	return &e
}
func (e *RouteJSONProtocol) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "ws":
		fallthrough
	case "wss":
		*e = RouteJSONProtocol(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RouteJSONProtocol: %v", v)
	}
}
...
func (o *RouteJSON) GetDestinations() []Destination {
	if o == nil {
		return nil
	}
...
func (o *RouteJSON) GetPathHandling() *RouteJSONPathHandling {
	if o == nil {
		return nil
	}
...
func (o *RouteJSON) GetProtocols() []RouteJSONProtocol {
	if o == nil {
		return nil
	}
	return o.Protocols
...
func (o *RouteJSON) GetSources() []Source {
	if o == nil {
		return nil
	}
	return o.Sources
