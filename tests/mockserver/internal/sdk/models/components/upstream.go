...
func (a ActiveHealthy) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *ActiveHealthy) UnmarshalJSON(data []byte) error {
...
func (o *ActiveHealthy) GetHTTPStatuses() []int64 {
	if o == nil {
		return nil
	}
...
func (o *ActiveHealthy) GetInterval() *float64 {
	if o == nil {
		return nil
	}
	return o.Interval
...
func (o *ActiveHealthy) GetSuccesses() *int64 {
	if o == nil {
		return nil
	}
	return o.Successes
...
const (
	ActiveTypeTCP   ActiveType = "tcp"
	ActiveTypeHTTP  ActiveType = "http"
	ActiveTypeHTTPS ActiveType = "https"
	ActiveTypeGrpc  ActiveType = "grpc"
	ActiveTypeGrpcs ActiveType = "grpcs"
)
...
func (a ActiveUnhealthy) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *ActiveUnhealthy) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *ActiveUnhealthy) GetHTTPFailures() *int64 {
	if o == nil {
		return nil
	}
...
func (o *ActiveUnhealthy) GetHTTPStatuses() []int64 {
	if o == nil {
		return nil
	}
	return o.HTTPStatuses
...
func (o *ActiveUnhealthy) GetInterval() *float64 {
	if o == nil {
		return nil
	}
	return o.Interval
...
func (o *ActiveUnhealthy) GetTCPFailures() *int64 {
	if o == nil {
		return nil
	}
...
func (o *ActiveUnhealthy) GetTimeouts() *int64 {
	if o == nil {
		return nil
	}
	return o.Timeouts
...
type Active struct {
	...
	Type                   *ActiveType       `default:"http" json:"type"`
...
func (o *Active) GetHealthy() *ActiveHealthy {
	if o == nil {
		return nil
	}
	return o.Healthy
...
func (o *Active) GetType() *ActiveType {
	if o == nil {
		return nil
	}
	return o.Type
...
func (o *Active) GetUnhealthy() *ActiveUnhealthy {
	if o == nil {
		return nil
	}
	return o.Unhealthy
...
func (p PassiveHealthy) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *PassiveHealthy) UnmarshalJSON(data []byte) error {
...
func (o *PassiveHealthy) GetHTTPStatuses() []int64 {
	if o == nil {
		return nil
	}
	return o.HTTPStatuses
...
func (o *PassiveHealthy) GetSuccesses() *int64 {
	if o == nil {
		return nil
	}
	return o.Successes
...
const (
	PassiveTypeTCP   PassiveType = "tcp"
	PassiveTypeHTTP  PassiveType = "http"
	PassiveTypeHTTPS PassiveType = "https"
	PassiveTypeGrpc  PassiveType = "grpc"
	PassiveTypeGrpcs PassiveType = "grpcs"
)

func (e PassiveType) ToPointer() *PassiveType {
	return &e
}
func (e *PassiveType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "grpcs":
		*e = PassiveType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PassiveType: %v", v)
	}
}
...
func (p PassiveUnhealthy) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *PassiveUnhealthy) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &p, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *PassiveUnhealthy) GetHTTPFailures() *int64 {
	if o == nil {
		return nil
	}
	return o.HTTPFailures
...
func (o *PassiveUnhealthy) GetHTTPStatuses() []int64 {
	if o == nil {
		return nil
	}
	return o.HTTPStatuses
...
func (o *PassiveUnhealthy) GetTCPFailures() *int64 {
	if o == nil {
		return nil
	}
	return o.TCPFailures
...
func (o *PassiveUnhealthy) GetTimeouts() *int64 {
	if o == nil {
		return nil
	}
	return o.Timeouts
...
type Passive struct {
	...
	Type      *PassiveType      `default:"http" json:"type"`
...
func (o *Passive) GetHealthy() *PassiveHealthy {
	if o == nil {
		return nil
	}
	return o.Healthy
...
func (o *Passive) GetType() *PassiveType {
	if o == nil {
		return nil
	}
	return o.Type
...
func (o *Passive) GetUnhealthy() *PassiveUnhealthy {
	if o == nil {
		return nil
	}
	return o.Unhealthy
