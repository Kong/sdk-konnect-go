...
type ListPortalsResponsePortalResponse struct {
...
func (l ListPortalsResponsePortalResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListPortalsResponsePortalResponse) UnmarshalJSON(data []byte) error {
...
func (o *ListPortalsResponsePortalResponse) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
func (o *ListPortalsResponsePortalResponse) GetCreatedAt() time.Time {
	if o == nil {
		return time.Time{}
	}
	return o.CreatedAt
...
func (o *ListPortalsResponsePortalResponse) GetUpdatedAt() time.Time {
	if o == nil {
		return time.Time{}
	}
	return o.UpdatedAt
...
func (o *ListPortalsResponsePortalResponse) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *ListPortalsResponsePortalResponse) GetDisplayName() string {
	if o == nil {
		return ""
	}
...
func (o *ListPortalsResponsePortalResponse) GetDescription() *string {
	if o == nil {
		return nil
	}
...
func (o *ListPortalsResponsePortalResponse) GetAuthenticationEnabled() *bool {
	if o == nil {
		return nil
	}
...
func (o *ListPortalsResponsePortalResponse) GetRbacEnabled() *bool {
	if o == nil {
		return nil
	}
...
func (o *ListPortalsResponsePortalResponse) GetDefaultAPIVisibility() ListPortalsResponseDefaultAPIVisibility {
	if o == nil {
...
func (o *ListPortalsResponsePortalResponse) GetDefaultPageVisibility() ListPortalsResponseDefaultPageVisibility {
	if o == nil {
...
func (o *ListPortalsResponsePortalResponse) GetDefaultApplicationAuthStrategyID() *string {
	if o == nil {
		return nil
	}
...
func (o *ListPortalsResponsePortalResponse) GetAutoApproveDevelopers() *bool {
	if o == nil {
		return nil
	}
...
func (o *ListPortalsResponsePortalResponse) GetAutoApproveApplications() *bool {
	if o == nil {
		return nil
	}
...
func (o *ListPortalsResponsePortalResponse) GetDefaultDomain() string {
	if o == nil {
		return ""
	}
...
func (o *ListPortalsResponsePortalResponse) GetCanonicalDomain() string {
	if o == nil {
		return ""
	}
...
func (o *ListPortalsResponsePortalResponse) GetLabels() map[string]string {
	if o == nil {
		return nil
	}
	return o.Labels
...
type ListPortalsResponse struct {
	Data []ListPortalsResponsePortalResponse `json:"data"`
	// returns the pagination information
	Meta PaginatedMeta `json:"meta"`
}

func (o *ListPortalsResponse) GetData() []ListPortalsResponsePortalResponse {
	if o == nil {
		return []ListPortalsResponsePortalResponse{}
	}
	return o.Data
}
