...
func (o *ClusterNode) GetPort() *int64 {
	if o == nil {
		return nil
	}
	return o.Port
...
func (o *SentinelNode) GetHost() *string {
	if o == nil {
		return nil
	}
	return o.Host
...
func (o *SentinelNode) GetPort() *int64 {
	if o == nil {
		return nil
	}
	return o.Port
...
type PartialRedisEeConfig struct {
	...
	SentinelNodes []SentinelNode `json:"sentinel_nodes,omitempty"`
...
func (o *PartialRedisEeConfig) GetClusterNodes() []ClusterNode {
	if o == nil {
		return nil
	}
...
func (o *PartialRedisEeConfig) GetSentinelNodes() []SentinelNode {
	if o == nil {
		return nil
	}
