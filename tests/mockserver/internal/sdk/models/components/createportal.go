...
type CreatePortalDefaultAPIVisibility string

const (
	CreatePortalDefaultAPIVisibilityPublic  CreatePortalDefaultAPIVisibility = "public"
	CreatePortalDefaultAPIVisibilityPrivate CreatePortalDefaultAPIVisibility = "private"
)

func (e CreatePortalDefaultAPIVisibility) ToPointer() *CreatePortalDefaultAPIVisibility {
	return &e
}
func (e *CreatePortalDefaultAPIVisibility) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "private":
		*e = CreatePortalDefaultAPIVisibility(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreatePortalDefaultAPIVisibility: %v", v)
	}
}

// CreatePortalDefaultPageVisibility - The default visibility of pages in the portal. If set to `public`, newly created pages are visible to unauthenticated developers. If set to `private`, newly created pages are hidden from unauthenticated developers.
type CreatePortalDefaultPageVisibility string

const (
	CreatePortalDefaultPageVisibilityPublic  CreatePortalDefaultPageVisibility = "public"
	CreatePortalDefaultPageVisibilityPrivate CreatePortalDefaultPageVisibility = "private"
)

func (e CreatePortalDefaultPageVisibility) ToPointer() *CreatePortalDefaultPageVisibility {
	return &e
}
func (e *CreatePortalDefaultPageVisibility) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "public":
		fallthrough
	case "private":
		*e = CreatePortalDefaultPageVisibility(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreatePortalDefaultPageVisibility: %v", v)
	}
}
...
type CreatePortal struct {
	...
	DefaultPageVisibility *CreatePortalDefaultPageVisibility `json:"default_page_visibility,omitempty"`
...
func (o *CreatePortal) GetDefaultAPIVisibility() *CreatePortalDefaultAPIVisibility {
	if o == nil {
		return nil
	}
...
func (o *CreatePortal) GetDefaultPageVisibility() *CreatePortalDefaultPageVisibility {
	if o == nil {
		return nil
	}
