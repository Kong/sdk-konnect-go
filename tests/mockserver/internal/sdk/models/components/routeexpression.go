...
const (
	RouteExpressionProtocolGrpc           RouteExpressionProtocol = "grpc"
	RouteExpressionProtocolGrpcs          RouteExpressionProtocol = "grpcs"
	RouteExpressionProtocolHTTP           RouteExpressionProtocol = "http"
	RouteExpressionProtocolHTTPS          RouteExpressionProtocol = "https"
	RouteExpressionProtocolTCP            RouteExpressionProtocol = "tcp"
	RouteExpressionProtocolTLS            RouteExpressionProtocol = "tls"
	RouteExpressionProtocolTLSPassthrough RouteExpressionProtocol = "tls_passthrough"
	RouteExpressionProtocolUDP            RouteExpressionProtocol = "udp"
	RouteExpressionProtocolWs             RouteExpressionProtocol = "ws"
	RouteExpressionProtocolWss            RouteExpressionProtocol = "wss"
)

func (e RouteExpressionProtocol) ToPointer() *RouteExpressionProtocol {
	return &e
}
func (e *RouteExpressionProtocol) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "ws":
		fallthrough
	case "wss":
		*e = RouteExpressionProtocol(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RouteExpressionProtocol: %v", v)
	}
}
...
func (o *RouteExpression) GetProtocols() []RouteExpressionProtocol {
	if o == nil {
		return nil
	}
	return o.Protocols
