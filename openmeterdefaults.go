...
// OpenMeterDefaults - Organization-level default configuration.
type OpenMeterDefaults struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newOpenMeterDefaults(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OpenMeterDefaults {
	return &OpenMeterDefaults{
		rootSDK:          rootSDK,
...
func (s *OpenMeterDefaults) GetOrganizationDefaultTaxCodes(ctx context.Context, opts ...operations.Option) (*operations.GetOrganizationDefaultTaxCodesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v3/openmeter/defaults/tax-codes")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			res.OrganizationDefaultTaxCodes = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
