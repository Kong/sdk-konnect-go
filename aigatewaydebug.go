...
// AIGatewayDebug - AI Gateway debug endpoints.
type AIGatewayDebug struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAIGatewayDebug(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AIGatewayDebug {
	return &AIGatewayDebug{
		rootSDK:          rootSDK,
...
func (s *AIGatewayDebug) GetAiGatewayDebugCpOutput(ctx context.Context, gatewayID string, opts ...operations.Option) (*operations.GetAiGatewayDebugCpOutputResponse, error) {
	request := operations.GetAiGatewayDebugCpOutputRequest{
		GatewayID: gatewayID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/debug-cp-output", request, nil)
	if err != nil {
	...
	res := &operations.GetAiGatewayDebugCpOutputResponse{
