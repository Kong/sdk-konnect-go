...
func newUpstreams(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Upstreams {
	return &Upstreams{
		rootSDK:          rootSDK,
...
func (s *Upstreams) ListUpstreamInWorkspace(ctx context.Context, request operations.ListUpstreamInWorkspaceRequest, opts ...operations.Option) (*operations.ListUpstreamInWorkspaceResponse, error) {
	...
	res := &operations.ListUpstreamInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListUpstreamInWorkspaceResponseBody
