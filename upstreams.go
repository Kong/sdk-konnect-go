...
func (s *Upstreams) CreateUpstream(ctx context.Context, controlPlaneID string, createUpstream components.CreateUpstream) (*operations.CreateUpstreamResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Upstreams) GetUpstream(ctx context.Context, controlPlaneID string, upstreamID string) (*operations.GetUpstreamResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
