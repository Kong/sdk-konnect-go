...
// AIGatewayNodes - API related to the management of AI Gateway nodes.
type AIGatewayNodes struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAIGatewayNodes(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AIGatewayNodes {
	return &AIGatewayNodes{
		rootSDK:          rootSDK,
...
func (s *AIGatewayNodes) GetAiGatewayExpectedConfigVersion(ctx context.Context, gatewayID string, opts ...operations.Option) (*operations.GetAiGatewayExpectedConfigVersionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/expected-config-version", request, nil)
	if err != nil {
	...
	res := &operations.GetAiGatewayExpectedConfigVersionResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AIGatewayExpectedConfigVersion
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AIGatewayExpectedConfigVersion = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayNodes) ListAiGatewayNodes(ctx context.Context, request operations.ListAiGatewayNodesRequest, opts ...operations.Option) (*operations.ListAiGatewayNodesResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/nodes", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListAiGatewayNodesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListAIGatewayDataPlaneNodesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAIGatewayDataPlaneNodesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayNodes) GetAiGatewayNode(ctx context.Context, gatewayID string, dataPlaneNodeID string, opts ...operations.Option) (*operations.GetAiGatewayNodeResponse, error) {
	request := operations.GetAiGatewayNodeRequest{
		GatewayID:       gatewayID,
		DataPlaneNodeID: dataPlaneNodeID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/nodes/{dataPlaneNodeId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetAiGatewayNodeResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AIGatewayDataPlaneNode
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AIGatewayDataPlaneNode = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayNodes) GetAiGatewayNodeConf(ctx context.Context, gatewayID string, dataPlaneNodeID string, opts ...operations.Option) (*operations.GetAiGatewayNodeConfResponse, error) {
	request := operations.GetAiGatewayNodeConfRequest{
		GatewayID:       gatewayID,
		DataPlaneNodeID: dataPlaneNodeID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/nodes/{dataPlaneNodeId}/conf", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get-ai-gateway-node-conf",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.GetAiGatewayNodeConfResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
