...
// AIGatewayCertificates - API related to the management of AI Gateway Certificates.
type AIGatewayCertificates struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAIGatewayCertificates(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AIGatewayCertificates {
	return &AIGatewayCertificates{
		rootSDK:          rootSDK,
...
func (s *AIGatewayCertificates) ListAiGatewayCertificates(ctx context.Context, request operations.ListAiGatewayCertificatesRequest, opts ...operations.Option) (*operations.ListAiGatewayCertificatesResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/certificates", request, nil)
	if err != nil {
	...
	res := &operations.ListAiGatewayCertificatesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListAIGatewayCertificatesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAIGatewayCertificatesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayCertificates) CreateAiGatewayCertificate(ctx context.Context, gatewayID string, createAIGatewayCertificateRequest components.CreateAIGatewayCertificateRequest, opts ...operations.Option) (*operations.CreateAiGatewayCertificateResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CreateAIGatewayCertificateRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateAiGatewayCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AIGatewayCertificate
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AIGatewayCertificate = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayCertificates) GetAiGatewayCertificate(ctx context.Context, gatewayID string, certificateIDOrName string, opts ...operations.Option) (*operations.GetAiGatewayCertificateResponse, error) {
	request := operations.GetAiGatewayCertificateRequest{
		GatewayID:           gatewayID,
		CertificateIDOrName: certificateIDOrName,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/certificates/{certificateIdOrName}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetAiGatewayCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *AIGatewayCertificates) UpdateAiGatewayCertificate(ctx context.Context, request operations.UpdateAiGatewayCertificateRequest, opts ...operations.Option) (*operations.UpdateAiGatewayCertificateResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateAIGatewayCertificateRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.UpdateAiGatewayCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *AIGatewayCertificates) DeleteAiGatewayCertificate(ctx context.Context, gatewayID string, certificateIDOrName string, opts ...operations.Option) (*operations.DeleteAiGatewayCertificateResponse, error) {
	...
	res := &operations.DeleteAiGatewayCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
