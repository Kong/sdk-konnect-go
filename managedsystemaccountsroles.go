...
type ManagedSystemAccountsRoles struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newManagedSystemAccountsRoles(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ManagedSystemAccountsRoles {
	return &ManagedSystemAccountsRoles{
		rootSDK:          rootSDK,
...
func (s *ManagedSystemAccountsRoles) GetSystemAccountsAssignedRolesInternal(ctx context.Context, accountID string, filter *operations.GetSystemAccountsAssignedRolesInternalQueryParamFilter, opts ...operations.Option) (*operations.GetSystemAccountsAssignedRolesInternalResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSystemAccountsAssignedRolesInternalServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/internal/system-accounts/{accountId}/assigned-roles", request, nil)
	if err != nil {
	...
	res := &operations.GetSystemAccountsAssignedRolesInternalResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ParameterizedAssignedRolesCollection
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ParameterizedAssignedRolesCollection = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *ManagedSystemAccountsRoles) CreateSystemAccountsAssignedRolesInternal(ctx context.Context, accountID string, assignParameterizedRole *components.AssignParameterizedRole, opts ...operations.Option) (*operations.CreateSystemAccountsAssignedRolesInternalResponse, error) {
	request := operations.CreateSystemAccountsAssignedRolesInternalRequest{
		AccountID:               accountID,
		AssignParameterizedRole: assignParameterizedRole,
	}
	...
	baseURL := utils.ReplaceParameters(operations.CreateSystemAccountsAssignedRolesInternalServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
	...
	res := &operations.CreateSystemAccountsAssignedRolesInternalResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ParameterizedAssignedRole
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ParameterizedAssignedRole = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
