...
// ListServerlessCloudGateway - List Serverless cloud gateways
// Returns an array of serverless cloud gateways objects.
func (s *ServerlessCloudGateways) ListServerlessCloudGateway(ctx context.Context, request operations.ListServerlessCloudGatewayRequest, opts ...operations.Option) (*operations.ListServerlessCloudGatewayResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.ListServerlessCloudGatewayServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
	...
	res := &operations.ListServerlessCloudGatewayResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out components.ListServerlessCloudGatewaysResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListServerlessCloudGatewaysResponse = &out
		default:
...
func (s *ServerlessCloudGateways) CreateServerlessCloudGateway(ctx context.Context, request components.CreateServerlessCloudGatewayRequest, opts ...operations.Option) (*operations.CreateServerlessCloudGatewayResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	case httpRes.StatusCode == 201:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out components.ServerlessCloudGateway
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *ServerlessCloudGateways) GetServerlessCloudGateway(ctx context.Context, controlPlaneID string, opts ...operations.Option) (*operations.GetServerlessCloudGatewayResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *ServerlessCloudGateways) DeleteServerlessCloudGateway(ctx context.Context, controlPlaneID string, opts ...operations.Option) (*operations.DeleteServerlessCloudGatewayResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
