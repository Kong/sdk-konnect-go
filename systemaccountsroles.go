...
func (s *SystemAccountsRoles) GetSystemAccountRole(ctx context.Context, accountID string, roleID string, opts ...operations.Option) (*operations.GetSystemAccountRoleResponse, error) {
	request := operations.GetSystemAccountRoleRequest{
		AccountID: accountID,
		RoleID:    roleID,
	}
