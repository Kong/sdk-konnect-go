...
func newAIGatewayDataPlane(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AIGatewayDataPlane {
	return &AIGatewayDataPlane{
		rootSDK:          rootSDK,
...
func (s *AIGatewayDataPlane) GetAiGatewayExpectedConfigVersion(ctx context.Context, gatewayID string, opts ...operations.Option) (*operations.GetAiGatewayExpectedConfigVersionResponse, error) {
