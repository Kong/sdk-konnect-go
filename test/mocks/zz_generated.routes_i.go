...
// SearchRoutes provides a mock function for the type MockRoutesSDK
func (_mock *MockRoutesSDK) SearchRoutes(ctx context.Context, request operations.SearchRoutesRequest, opts ...operations.Option) (*operations.SearchRoutesResponse, error) {
	var tmpRet mock.Arguments
	if len(opts) > 0 {
		tmpRet = _mock.Called(ctx, request, opts)
	} else {
	...
	if len(ret) == 0 {
		panic("no return value specified for SearchRoutes")
	}

	var r0 *operations.SearchRoutesResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, operations.SearchRoutesRequest, ...operations.Option) (*operations.SearchRoutesResponse, error)); ok {
		return returnFunc(ctx, request, opts...)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, operations.SearchRoutesRequest, ...operations.Option) *operations.SearchRoutesResponse); ok {
		r0 = returnFunc(ctx, request, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*operations.SearchRoutesResponse)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, operations.SearchRoutesRequest, ...operations.Option) error); ok {
		r1 = returnFunc(ctx, request, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockRoutesSDK_SearchRoutes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SearchRoutes'
type MockRoutesSDK_SearchRoutes_Call struct {
	*mock.Call
}

// SearchRoutes is a helper method to define mock.On call
//   - ctx context.Context
//   - request operations.SearchRoutesRequest
//   - opts ...operations.Option
func (_e *MockRoutesSDK_Expecter) SearchRoutes(ctx any, request any, opts ...any) *MockRoutesSDK_SearchRoutes_Call {
	return &MockRoutesSDK_SearchRoutes_Call{Call: _e.mock.On("SearchRoutes",
		append([]any{ctx, request}, opts...)...)}
}

func (_c *MockRoutesSDK_SearchRoutes_Call) Run(run func(ctx context.Context, request operations.SearchRoutesRequest, opts ...operations.Option)) *MockRoutesSDK_SearchRoutes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 operations.SearchRoutesRequest
		if args[1] != nil {
			arg1 = args[1].(operations.SearchRoutesRequest)
		}
		var arg2 []operations.Option
		var variadicArgs []operations.Option
		if len(args) > 2 {
...
func (_c *MockRoutesSDK_SearchRoutes_Call) Return(searchRoutesResponse *operations.SearchRoutesResponse, err error) *MockRoutesSDK_SearchRoutes_Call {
	_c.Call.Return(searchRoutesResponse, err)
	return _c
}

func (_c *MockRoutesSDK_SearchRoutes_Call) RunAndReturn(run func(ctx context.Context, request operations.SearchRoutesRequest, opts ...operations.Option) (*operations.SearchRoutesResponse, error)) *MockRoutesSDK_SearchRoutes_Call {
	_c.Call.Return(run)
	return _c
}
