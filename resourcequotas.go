...
func newResourceQuotas(sdkConfig sdkConfiguration) *ResourceQuotas {
...
func (s *ResourceQuotas) ListDefaultResourceQuotas(ctx context.Context, pageSize *int64, pageNumber *int64, opts ...operations.Option) (*operations.ListDefaultResourceQuotasResponse, error) {
...
func (s *ResourceQuotas) ListResourceQuotas(ctx context.Context, pageSize *int64, pageNumber *int64, opts ...operations.Option) (*operations.ListResourceQuotasResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *ResourceQuotas) GetResourceQuota(ctx context.Context, resourceQuotaID string, opts ...operations.Option) (*operations.GetResourceQuotaResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
