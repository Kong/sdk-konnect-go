...
func (s *PortalDevelopers) CreateDeveloper(ctx context.Context, portalID string, createDeveloperRequest components.CreateDeveloperRequest, opts ...operations.Option) (*operations.CreateDeveloperResponse, error) {
	request := operations.CreateDeveloperRequest{
		PortalID:               portalID,
