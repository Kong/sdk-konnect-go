...
func (s *APIGateways) GetAPIGateway(ctx context.Context, gatewayID string, opts ...operations.Option) (*operations.GetAPIGatewayResponse, error) {
	request := operations.GetAPIGatewayRequest{
		GatewayID: gatewayID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/api-gateways/{gatewayId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetAPIGatewayResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *APIGateways) UpdateAPIGateway(ctx context.Context, gatewayID string, updateGatewayRequest components.UpdateGatewayRequest, opts ...operations.Option) (*operations.UpdateAPIGatewayResponse, error) {
	request := operations.UpdateAPIGatewayRequest{
		GatewayID:            gatewayID,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "update-api-gateway",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.UpdateAPIGatewayResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *APIGateways) DeleteAPIGateway(ctx context.Context, gatewayID string, opts ...operations.Option) (*operations.DeleteAPIGatewayResponse, error) {
	request := operations.DeleteAPIGatewayRequest{
		GatewayID: gatewayID,
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "delete-api-gateway",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.DeleteAPIGatewayResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
