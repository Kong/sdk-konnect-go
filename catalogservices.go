...
func newCatalogServices(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CatalogServices {
...
// Creates a service.
func (s *CatalogServices) CreateCatalogService(ctx context.Context, request components.CreateCatalogService, opts ...operations.Option) (*operations.CreateCatalogServiceResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CatalogService
...
func (s *CatalogServices) ListCatalogServices(ctx context.Context, request operations.ListCatalogServicesRequest, opts ...operations.Option) (*operations.ListCatalogServicesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.ListCatalogServicesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListCatalogServicesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListCatalogServicesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// Fetches a service.
func (s *CatalogServices) FetchCatalogService(ctx context.Context, id string, opts ...operations.Option) (*operations.FetchCatalogServiceResponse, error) {
	request := operations.FetchCatalogServiceRequest{
		ID: id,
	}
...
// Updates a service.
func (s *CatalogServices) UpdateCatalogService(ctx context.Context, id string, updateCatalogService components.UpdateCatalogService, opts ...operations.Option) (*operations.UpdateCatalogServiceResponse, error) {
	request := operations.UpdateCatalogServiceRequest{
		ID:                   id,
...
// Deletes a service.
func (s *CatalogServices) DeleteCatalogService(ctx context.Context, id string, opts ...operations.Option) (*operations.DeleteCatalogServiceResponse, error) {
	request := operations.DeleteCatalogServiceRequest{
		ID: id,
	}
