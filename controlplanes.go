...
func (s *ControlPlanes) GetControlPlane(ctx context.Context, id string) (*operations.GetControlPlaneResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *ControlPlanes) UpdateControlPlane(ctx context.Context, id string, updateControlPlaneRequest components.UpdateControlPlaneRequest) (*operations.UpdateControlPlaneResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *ControlPlanes) DeleteControlPlane(ctx context.Context, id string) (*operations.DeleteControlPlaneResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
