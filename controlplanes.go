...
func newControlPlanes(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ControlPlanes {
...
func (s *ControlPlanes) ListControlPlanes(ctx context.Context, request operations.ListControlPlanesRequest, opts ...operations.Option) (*operations.ListControlPlanesResponse, error) {
	...
	res.Next = func() (*operations.ListControlPlanesResponse, error) {
...
func (s *ControlPlanes) GetControlPlaneSettings(ctx context.Context, controlPlaneID string, opts ...operations.Option) (*operations.GetControlPlaneSettingsResponse, error) {
	request := operations.GetControlPlaneSettingsRequest{
		ControlPlaneID: controlPlaneID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/settings", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get-control-plane-settings",
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.GetControlPlaneSettingsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *ControlPlanes) PutControlPlaneSettings(ctx context.Context, controlPlaneID string, settings *components.Settings, opts ...operations.Option) (*operations.PutControlPlaneSettingsResponse, error) {
	request := operations.PutControlPlaneSettingsRequest{
		ControlPlaneID: controlPlaneID,
		Settings:       settings,
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "put-control-plane-settings",
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "Settings", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.PutControlPlaneSettingsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
