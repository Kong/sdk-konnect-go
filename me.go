...
func newMe(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Me {
	return &Me{
		rootSDK:          rootSDK,
...
func (s *Me) DeleteUsersMe(ctx context.Context, opts ...operations.Option) (*operations.DeleteUsersMeResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.DeleteUsersMeServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
	...
	res := &operations.DeleteUsersMeResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Me) PatchUsersMe(ctx context.Context, request *components.UpdateUser, opts ...operations.Option) (*operations.PatchUsersMeResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.PatchUsersMeServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
	...
	res := &operations.PatchUsersMeResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Me) GetUsersMePermissions(ctx context.Context, filter *operations.GetUsersMePermissionsQueryParamFilter, opts ...operations.Option) (*operations.GetUsersMePermissionsResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetUsersMePermissionsServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/v3/users/me/permissions")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetUsersMePermissionsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.UserPermissions
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UserPermissions = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Me) RetrieveUsersMePermissions(ctx context.Context, retrieveMyPermissionsBatchRequest components.RetrieveMyPermissionsBatchRequest, page *components.RetrieveMyPermissionsCursorPageQuery, opts ...operations.Option) (*operations.RetrieveUsersMePermissionsResponse, error) {
	request := operations.RetrieveUsersMePermissionsRequest{
		Page:                              page,
		RetrieveMyPermissionsBatchRequest: retrieveMyPermissionsBatchRequest,
	}
	...
	baseURL := utils.ReplaceParameters(operations.RetrieveUsersMePermissionsServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/v3/users/me/retrieve-permissions")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "retrieve-users-me-permissions",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "RetrieveMyPermissionsBatchRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	if err := utils.PopulateSecurity(ctx, req, s.sdkConfiguration.Security, "PersonalAccessToken", "SystemAccountAccessToken", "KonnectAccessToken"); err != nil {
		return nil, err
	}
	...
	res := &operations.RetrieveUsersMePermissionsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.RetrieveMyPermissionsBatchResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.RetrieveMyPermissionsBatchResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Me) UpdateOrganizationsMe(ctx context.Context, request *components.UpdateOrganization, opts ...operations.Option) (*operations.UpdateOrganizationsMeResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	baseURL := utils.ReplaceParameters(operations.UpdateOrganizationsMeServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
	...
	res := &operations.UpdateOrganizationsMeResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
