...
func (s *ConsumerGroups) CreateConsumerGroup(ctx context.Context, controlPlaneID string, createConsumerGroup components.CreateConsumerGroup) (*operations.CreateConsumerGroupResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *ConsumerGroups) GetConsumerGroup(ctx context.Context, controlPlaneID string, consumerGroupID string) (*operations.GetConsumerGroupResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
