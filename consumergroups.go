...
func (s *ConsumerGroups) ListConsumerGroupInWorkspace(ctx context.Context, request operations.ListConsumerGroupInWorkspaceRequest, opts ...operations.Option) (*operations.ListConsumerGroupInWorkspaceResponse, error) {
	...
	res := &operations.ListConsumerGroupInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListConsumerGroupInWorkspaceResponseBody
...
func (s *ConsumerGroups) RemoveAllConsumersFromConsumerGroupInWorkspace(ctx context.Context, request operations.RemoveAllConsumersFromConsumerGroupInWorkspaceRequest, opts ...operations.Option) (*operations.RemoveAllConsumersFromConsumerGroupInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.RemoveAllConsumersFromConsumerGroupInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *ConsumerGroups) ListConsumersForConsumerGroupInWorkspace(ctx context.Context, request operations.ListConsumersForConsumerGroupInWorkspaceRequest, opts ...operations.Option) (*operations.ListConsumersForConsumerGroupInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.ListConsumersForConsumerGroupInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListConsumersForConsumerGroupInWorkspaceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
