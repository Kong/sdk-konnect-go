...
func (s *Targets) ListTargets(ctx context.Context, request operations.ListTargetsRequest, opts ...operations.Option) (*operations.ListTargetsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/targets", request, nil)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListTargets
...
// Returns a collection of all targets for a control plane.
func (s *Targets) ListTargetsInWorkspace(ctx context.Context, request operations.ListTargetsInWorkspaceRequest, opts ...operations.Option) (*operations.ListTargetsInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/targets", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListTargetsInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Targets) ListTargetWithUpstreamInWorkspace(ctx context.Context, request operations.ListTargetWithUpstreamInWorkspaceRequest, opts ...operations.Option) (*operations.ListTargetWithUpstreamInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/upstreams/{UpstreamIdForTarget}/targets", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListTargetWithUpstreamInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListTargetWithUpstreamInWorkspaceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Targets) DeleteTargetWithUpstreamInWorkspace(ctx context.Context, request operations.DeleteTargetWithUpstreamInWorkspaceRequest, opts ...operations.Option) (*operations.DeleteTargetWithUpstreamInWorkspaceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/upstreams/{UpstreamIdForTarget}/targets/{TargetId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Targets) UpsertTargetWithUpstreamInWorkspace(ctx context.Context, request operations.UpsertTargetWithUpstreamInWorkspaceRequest, opts ...operations.Option) (*operations.UpsertTargetWithUpstreamInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.UpsertTargetWithUpstreamInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
