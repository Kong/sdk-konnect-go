...
func newMTLSAuthCredentials(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MTLSAuthCredentials {
...
func (s *MTLSAuthCredentials) ListMtlsAuthWithConsumerInWorkspace(ctx context.Context, request operations.ListMtlsAuthWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.ListMtlsAuthWithConsumerInWorkspaceResponse, error) {
	...
	res := &operations.ListMtlsAuthWithConsumerInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListMtlsAuthWithConsumerInWorkspaceResponseBody
...
func (s *MTLSAuthCredentials) UpsertMtlsAuthWithConsumerInWorkspace(ctx context.Context, request operations.UpsertMtlsAuthWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.UpsertMtlsAuthWithConsumerInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.UpsertMtlsAuthWithConsumerInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *MTLSAuthCredentials) ListMtlsAuthInWorkspace(ctx context.Context, request operations.ListMtlsAuthInWorkspaceRequest, opts ...operations.Option) (*operations.ListMtlsAuthInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/mtls-auths", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListMtlsAuthInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListMtlsAuthInWorkspaceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *MTLSAuthCredentials) GetMtlsAuthInWorkspace(ctx context.Context, request operations.GetMtlsAuthInWorkspaceRequest, opts ...operations.Option) (*operations.GetMtlsAuthInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/mtls-auths/{MTLSAuthId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetMtlsAuthInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
