...
func newSystemAccounts(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SystemAccounts {
...
func (s *SystemAccounts) GetSystemAccounts(ctx context.Context, request operations.GetSystemAccountsRequest, opts ...operations.Option) (*operations.GetSystemAccountsResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSystemAccountsServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
	...
	res.Next = func() (*operations.GetSystemAccountsResponse, error) {
