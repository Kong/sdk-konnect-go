...
func (s *SystemAccounts) PostSystemAccounts(ctx context.Context, request *components.CreateSystemAccount) (*operations.PostSystemAccountsResponse, error) {
	...
	if err != nil || httpRes == nil {
		...
		return nil, err
	} else if utils.MatchStatusCodes([]string{"401", "403", "409", "4XX", "5XX"}, httpRes.StatusCode) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out components.SystemAccount
...
func (s *SystemAccounts) GetSystemAccountsID(ctx context.Context, accountID string) (*operations.GetSystemAccountsIDResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *SystemAccounts) PatchSystemAccountsID(ctx context.Context, accountID string, updateSystemAccount *components.UpdateSystemAccount) (*operations.PatchSystemAccountsIDResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *SystemAccounts) DeleteSystemAccountsID(ctx context.Context, accountID string) (*operations.DeleteSystemAccountsIDResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
