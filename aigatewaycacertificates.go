...
// AIGatewayCACertificates - API related to the management of AI Gateway CA Certificates.
type AIGatewayCACertificates struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAIGatewayCACertificates(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AIGatewayCACertificates {
	return &AIGatewayCACertificates{
		rootSDK:          rootSDK,
...
func (s *AIGatewayCACertificates) ListAiGatewayCaCertificates(ctx context.Context, request operations.ListAiGatewayCaCertificatesRequest, opts ...operations.Option) (*operations.ListAiGatewayCaCertificatesResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/ca-certificates", request, nil)
	if err != nil {
	...
	res := &operations.ListAiGatewayCaCertificatesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListAIGatewayCACertificatesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAIGatewayCACertificatesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayCACertificates) CreateAiGatewayCaCertificate(ctx context.Context, gatewayID string, createAIGatewayCACertificateRequest components.CreateAIGatewayCACertificateRequest, opts ...operations.Option) (*operations.CreateAiGatewayCaCertificateResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CreateAIGatewayCACertificateRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateAiGatewayCaCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AIGatewayCACertificate
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AIGatewayCACertificate = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayCACertificates) GetAiGatewayCaCertificate(ctx context.Context, gatewayID string, caCertificateIDOrName string, opts ...operations.Option) (*operations.GetAiGatewayCaCertificateResponse, error) {
	request := operations.GetAiGatewayCaCertificateRequest{
		GatewayID:             gatewayID,
		CaCertificateIDOrName: caCertificateIDOrName,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/ca-certificates/{caCertificateIdOrName}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetAiGatewayCaCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *AIGatewayCACertificates) UpdateAiGatewayCaCertificate(ctx context.Context, request operations.UpdateAiGatewayCaCertificateRequest, opts ...operations.Option) (*operations.UpdateAiGatewayCaCertificateResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateAIGatewayCACertificateRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.UpdateAiGatewayCaCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *AIGatewayCACertificates) DeleteAiGatewayCaCertificate(ctx context.Context, gatewayID string, caCertificateIDOrName string, opts ...operations.Option) (*operations.DeleteAiGatewayCaCertificateResponse, error) {
	...
	res := &operations.DeleteAiGatewayCaCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
