...
func (s *JWTs) ListJwtWithConsumerInWorkspace(ctx context.Context, request operations.ListJwtWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.ListJwtWithConsumerInWorkspaceResponse, error) {
	...
	res := &operations.ListJwtWithConsumerInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListJwtWithConsumerInWorkspaceResponseBody
...
func (s *JWTs) UpsertJwtWithConsumerInWorkspace(ctx context.Context, request operations.UpsertJwtWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.UpsertJwtWithConsumerInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.UpsertJwtWithConsumerInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *JWTs) ListJwtInWorkspace(ctx context.Context, request operations.ListJwtInWorkspaceRequest, opts ...operations.Option) (*operations.ListJwtInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/jwts", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListJwtInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListJwtInWorkspaceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *JWTs) GetJwtInWorkspace(ctx context.Context, request operations.GetJwtInWorkspaceRequest, opts ...operations.Option) (*operations.GetJwtInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/jwts/{JWTId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetJwtInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
