...
func (s *AIGateways) PatchAiGateway(ctx context.Context, gatewayID string, patchAIGatewayRequest components.PatchAIGatewayRequest, opts ...operations.Option) (*operations.PatchAiGatewayResponse, error) {
	request := operations.PatchAiGatewayRequest{
		GatewayID:             gatewayID,
		PatchAIGatewayRequest: patchAIGatewayRequest,
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "PatchAIGatewayRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.PatchAiGatewayResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
