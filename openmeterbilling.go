...
func (s *OpenMeterBilling) ListCurrencies(ctx context.Context, request operations.ListCurrenciesRequest, opts ...operations.Option) (*operations.ListCurrenciesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v3/openmeter/currencies")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CurrencyPagePaginatedResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CurrencyPagePaginatedResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *OpenMeterBilling) CreateCustomCurrency(ctx context.Context, request components.CreateCurrencyCustomRequest, opts ...operations.Option) (*operations.CreateCustomCurrencyResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v3/openmeter/currencies/custom")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *OpenMeterBilling) ListCostBases(ctx context.Context, request operations.ListCostBasesRequest, opts ...operations.Option) (*operations.ListCostBasesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/openmeter/currencies/custom/{currencyId}/cost-bases", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CostBasisPagePaginatedResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CostBasisPagePaginatedResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *OpenMeterBilling) CreateCostBasis(ctx context.Context, currencyID string, createCostBasisRequest components.CreateCostBasisRequest, opts ...operations.Option) (*operations.CreateCostBasisResponse, error) {
	request := operations.CreateCostBasisRequest{
		CurrencyID:             currencyID,
		CreateCostBasisRequest: createCostBasisRequest,
	}
...
// usage-based charges.
func (s *OpenMeterBilling) ListCustomerCharges(ctx context.Context, request operations.ListCustomerChargesRequest, opts ...operations.Option) (*operations.ListCustomerChargesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
