...
// AIGatewayMCPServers - MCP Servers that expose tools for AI Gateway integrations.
type AIGatewayMCPServers struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAIGatewayMCPServers(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AIGatewayMCPServers {
	return &AIGatewayMCPServers{
		rootSDK:          rootSDK,
...
func (s *AIGatewayMCPServers) ListAiGatewayMcpServers(ctx context.Context, request operations.ListAiGatewayMcpServersRequest, opts ...operations.Option) (*operations.ListAiGatewayMcpServersResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/mcp-servers", request, nil)
	if err != nil {
	...
	res := &operations.ListAiGatewayMcpServersResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListAIGatewayMCPServersResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAIGatewayMCPServersResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayMCPServers) CreateAiGatewayMcpServer(ctx context.Context, gatewayID string, createAIGatewayMCPServerRequest components.CreateAIGatewayMCPServerRequest, opts ...operations.Option) (*operations.CreateAiGatewayMcpServerResponse, error) {
	...
	res := &operations.CreateAiGatewayMcpServerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AIGatewayMCPServer
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *AIGatewayMCPServers) GetAiGatewayMcpServer(ctx context.Context, gatewayID string, mcpServerID string, opts ...operations.Option) (*operations.GetAiGatewayMcpServerResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/mcp-servers/{mcpServerId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetAiGatewayMcpServerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *AIGatewayMCPServers) UpdateAiGatewayMcpServer(ctx context.Context, request operations.UpdateAiGatewayMcpServerRequest, opts ...operations.Option) (*operations.UpdateAiGatewayMcpServerResponse, error) {
	...
	res := &operations.UpdateAiGatewayMcpServerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *AIGatewayMCPServers) DeleteAiGatewayMcpServer(ctx context.Context, gatewayID string, mcpServerID string, opts ...operations.Option) (*operations.DeleteAiGatewayMcpServerResponse, error) {
	...
	res := &operations.DeleteAiGatewayMcpServerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
