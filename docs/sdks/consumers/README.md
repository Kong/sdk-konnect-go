...
* [SearchConsumers](#searchconsumers) - Search Consumers
...
<!-- UsageSnippet language="go" operationID="search-consumers" method="get" path="/v2/control-planes/{controlPlaneId}/core-entities/consumers/search" -->
```go
package main
...
func main() {
    ...
    res, err := s.Consumers.SearchConsumers(ctx, operations.SearchConsumersRequest{
        ControlPlaneID: "9524ec7d-36d9-465d-a8c5-83a3c9390458",
        Tags: sdkkonnectgo.Pointer("tag1,tag2"),
    })
    if err != nil {
...
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `ctx`                                                                                  | [context.Context](https://pkg.go.dev/context#Context)                                  | :heavy_check_mark:                                                                     | The context to use for the request.                                                    |
| `request`                                                                              | [operations.SearchConsumersRequest](../../models/operations/searchconsumersrequest.md) | :heavy_check_mark:                                                                     | The request object to use for the request.                                             |
| `opts`                                                                                 | [][operations.Option](../../models/operations/option.md)                               | :heavy_minus_sign:                                                                     | The options for this request.                                                          |

### Response

**[*operations.SearchConsumersResponse](../../models/operations/searchconsumersresponse.md), error**
