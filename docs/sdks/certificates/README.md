...
func main() {
    ...
    res, err := s.Certificates.CreateCertificate(ctx, "9524ec7d-36d9-465d-a8c5-83a3c9390458", components.CertificateInput{
...
| `certificate`                                                                                                                                                                                                                 | [components.CertificateInput](../../models/components/certificateinput.md)                                                                                                                                                    | :heavy_check_mark:                                                                                                                                                                                                            | Description of the new Certificate for creation                                                                                                                                                                               | {<br/>"cert": "-----BEGIN CERTIFICATE-----\ncertificate-content\n-----END CERTIFICATE-----",<br/>"id": "b2f34145-0343-41a4-9602-4c69dec2f269",<br/>"key": "-----BEGIN PRIVATE KEY-----\nprivate-key-content\n-----END PRIVATE KEY-----"<br/>} |
| `opts`                                                                                                                                                                                                                        | [][operations.Option](../../models/operations/option.md)                                                                                                                                                                      | :heavy_minus_sign:                                                                                                                                                                                                            | The options for this request.                                                                                                                                                                                                 |                                                                                                                                                                                                                               |
