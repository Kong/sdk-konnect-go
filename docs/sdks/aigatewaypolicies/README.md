...
* [ListAiGatewayAvailablePolicies](#listaigatewayavailablepolicies) - List AI Gateway Available Policies
* [GetAiGatewayPolicySchema](#getaigatewaypolicyschema) - Get an AI Gateway Policy Schema
...
* [ListAiGatewayPolicyUsage](#listaigatewaypolicyusage) - List AI Gateway Policy Usage

## ListAiGatewayAvailablePolicies

Returns a list of available policies for the AI Gateway.

### Example Usage

<!-- UsageSnippet language="go" operationID="list-ai-gateway-available-policies" method="get" path="/v1/ai-gateways/{gatewayId}/available-policies" -->
```go
package main
...
func main() {
    ...
    res, err := s.AIGatewayPolicies.ListAiGatewayAvailablePolicies(ctx, "bf138ba2-c9b1-4229-b268-04d9d8a6410b")
    if err != nil {
        log.Fatal(err)
    }
    if res.ListAIGatewayAvailablePoliciesResponse != nil {
        // handle response
    }
}
```
...
**[*operations.ListAiGatewayAvailablePoliciesResponse](../../models/operations/listaigatewayavailablepoliciesresponse.md), error**
...
## GetAiGatewayPolicySchema

Returns the details of a specific AI Gateway policy schema using the schema name.

### Example Usage

<!-- UsageSnippet language="go" operationID="get-ai-gateway-policy-schema" method="get" path="/v1/ai-gateways/{gatewayId}/policies/schemas/{policySchemaName}" -->
```go
package main
...
func main() {
    ...
    res, err := s.AIGatewayPolicies.GetAiGatewayPolicySchema(ctx, "bf138ba2-c9b1-4229-b268-04d9d8a6410b", "ai-sanitizer")
    if err != nil {
        log.Fatal(err)
    }
    if res.AIGatewayPolicySchema != nil {
        // handle response
    }
}
```
...
**[*operations.GetAiGatewayPolicySchemaResponse](../../models/operations/getaigatewaypolicyschemaresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="list-ai-gateway-policy-usage" method="get" path="/v1/ai-gateways/{gatewayId}/policies/{policyId}/usage" -->
```go
package main
...
func main() {
    ...
    res, err := s.AIGatewayPolicies.ListAiGatewayPolicyUsage(ctx, "bf138ba2-c9b1-4229-b268-04d9d8a6410b", "bf138ba2-c9b1-4229-b268-04d9d8a6410b")
    if err != nil {
        log.Fatal(err)
    }
    if res.ListAIGatewayPolicyUsageResponse != nil {
        // handle response
    }
}
```
...
**[*operations.ListAiGatewayPolicyUsageResponse](../../models/operations/listaigatewaypolicyusageresponse.md), error**
