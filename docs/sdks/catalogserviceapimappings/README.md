...
func main() {
    ...
    res, err := s.CatalogServiceAPIMappings.ListCatalogServiceAPIMappings(ctx, operations.ListCatalogServiceAPIMappingsRequest{
        ServiceID: "3e597c64-e8fd-4648-bd3e-a53908717f58",
...
func main() {
    ...
    res, err := s.CatalogServiceAPIMappings.CreateCatalogServiceAPIMapping(ctx, "b62378bb-9de2-4d83-978e-53111884bbc9", components.CreateCatalogServiceAPIMappingBody{
...
func main() {
    ...
    res, err := s.CatalogServiceAPIMappings.GetCatalogServiceAPIMapping(ctx, "8bba58b8-70b6-4fa7-8333-604e1e49abd5", "d277faad-ed4e-4c56-a0fb-acce065dee34")
    if err != nil {
        log.Fatal(err)
    }
    if res.CatalogServiceAPIMapping != nil {
...
func main() {
    ...
    res, err := s.CatalogServiceAPIMappings.DeleteCatalogServiceAPIMapping(ctx, "902da31c-13fe-46ba-8227-27e08fb7ec1e", "d277faad-ed4e-4c56-a0fb-acce065dee34")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
