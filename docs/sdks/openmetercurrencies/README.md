...
* [GetCustomCurrency](#getcustomcurrency) - Get custom currency
...
<!-- UsageSnippet language="go" operationID="get-custom-currency" method="get" path="/v3/openmeter/currencies/custom/{currencyId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.OpenMeterCurrencies.GetCustomCurrency(ctx, "01G65Z755AFWAKHE12NY0CQ9FH")
    if err != nil {
        log.Fatal(err)
    }
    if res.BillingCurrencyCustom != nil {
...
**[*operations.GetCustomCurrencyResponse](../../models/operations/getcustomcurrencyresponse.md), error**
