...
* [SearchRoutes](#searchroutes) - Search Routes
...
<!-- UsageSnippet language="go" operationID="search-routes" method="get" path="/v2/control-planes/{controlPlaneId}/core-entities/routes/search" -->
```go
package main
...
func main() {
    ...
    res, err := s.Routes.SearchRoutes(ctx, operations.SearchRoutesRequest{
        ControlPlaneID: "9524ec7d-36d9-465d-a8c5-83a3c9390458",
        Tags: sdkkonnectgo.Pointer("tag1,tag2"),
    })
    if err != nil {
...
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| `ctx`                                                                            | [context.Context](https://pkg.go.dev/context#Context)                            | :heavy_check_mark:                                                               | The context to use for the request.                                              |
| `request`                                                                        | [operations.SearchRoutesRequest](../../models/operations/searchroutesrequest.md) | :heavy_check_mark:                                                               | The request object to use for the request.                                       |
| `opts`                                                                           | [][operations.Option](../../models/operations/option.md)                         | :heavy_minus_sign:                                                               | The options for this request.                                                    |

### Response

**[*operations.SearchRoutesResponse](../../models/operations/searchroutesresponse.md), error**
