...
* [GetAiGatewayNodeConf](#getaigatewaynodeconf) - Get a Node Process Conf
...
func main() {
    ...
    res, err := s.AIGatewayNodes.GetAiGatewayExpectedConfigVersion(ctx, "bf138ba2-c9b1-4229-b268-04d9d8a6410b")
    if err != nil {
        log.Fatal(err)
    }
...
## GetAiGatewayNodeConf

Returns the Kong Gateway configuration this node reported when it connected.

### Example Usage

<!-- UsageSnippet language="go" operationID="get-ai-gateway-node-conf" method="get" path="/v1/ai-gateways/{gatewayId}/nodes/{dataPlaneNodeId}/conf" -->
```go
package main
...
func main() {
    ...
    res, err := s.AIGatewayNodes.GetAiGatewayNodeConf(ctx, "bf138ba2-c9b1-4229-b268-04d9d8a6410b", "bf138ba2-c9b1-4229-b268-04d9d8a6410b")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
**[*operations.GetAiGatewayNodeConfResponse](../../models/operations/getaigatewaynodeconfresponse.md), error**
