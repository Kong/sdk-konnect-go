...
<!-- UsageSnippet language="go" operationID="list-targets" method="get" path="/v2/control-planes/{controlPlaneId}/core-entities/targets" -->
```go
package main
...
func main() {
    ...
    res, err := s.Targets.ListTargets(ctx, operations.ListTargetsRequest{
...
| `request`                                                                      | [operations.ListTargetsRequest](../../models/operations/listtargetsrequest.md) | :heavy_check_mark:                                                             | The request object to use for the request.                                     |
| `opts`                                                                         | [][operations.Option](../../models/operations/option.md)                       | :heavy_minus_sign:                                                             | The options for this request.                                                  |

### Response

**[*operations.ListTargetsResponse](../../models/operations/listtargetsresponse.md), error**
