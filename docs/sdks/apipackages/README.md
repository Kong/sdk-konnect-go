...
* [ListAPIPackageRegistrations](#listapipackageregistrations) - List API Package Registrations
...
func main() {
    ...
    res, err := s.APIPackages.CreateAPIPackage(ctx, components.CreateAPIPackageRequest{
        ...
        EnvironmentID: sdkkonnectgo.Pointer("2747d1e5-8246-4f65-a939-b392f1ee17f8"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
## ListAPIPackageRegistrations

Returns a paginated list of registrations for an API Package.

### Example Usage

<!-- UsageSnippet language="go" operationID="list-api-package-registrations" method="get" path="/v3/api-packages/{apiPackageId}/registrations" -->
```go
package main
...
func main() {
    ...
    res, err := s.APIPackages.ListAPIPackageRegistrations(ctx, operations.ListAPIPackageRegistrationsRequest{
    ...
    if res.APIPackageRegistrationsListResponse != nil {
        // handle response
    }
}
```
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                          | [context.Context](https://pkg.go.dev/context#Context)                                                          | :heavy_check_mark:                                                                                             | The context to use for the request.                                                                            |
| `request`                                                                                                      | [operations.ListAPIPackageRegistrationsRequest](../../models/operations/listapipackageregistrationsrequest.md) | :heavy_check_mark:                                                                                             | The request object to use for the request.                                                                     |
| `opts`                                                                                                         | [][operations.Option](../../models/operations/option.md)                                                       | :heavy_minus_sign:                                                                                             | The options for this request.                                                                                  |

### Response

**[*operations.ListAPIPackageRegistrationsResponse](../../models/operations/listapipackageregistrationsresponse.md), error**
