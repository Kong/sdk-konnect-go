...
func main() {
    ...
    res, err := s.EventGatewayListenerPolicies.CreateEventGatewayListenerPolicy(ctx, operations.CreateEventGatewayListenerPolicyRequest{
        GatewayID: "9524ec7d-36d9-465d-a8c5-83a3c9390458",
        ListenerID: "07fe243a-f93d-422d-bff7-396e794e6256",
            ...
            components.EventGatewayTLSListenerPolicy{
                Config: components.EventGatewayTLSListenerPolicyConfig{
                    ...
                    ClientAuthentication: &components.ClientAuthentication{
                        Mode: components.EventGatewayTLSListenerPolicyConfigModeRequired,
                        TLSTrustBundles: []components.TLSTrustBundleReference{},
                        PrincipalMapping: sdkkonnectgo.Pointer("${context.certificate.subject['CN'] ? context.certificate.subject['CN'] : context.certificate.sans.uri[0]}"),
                    },
                },
            },
        ),
