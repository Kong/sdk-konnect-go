...
* [PublishAPIToPortalInEnvironment](#publishapitoportalinenvironment) - Publish API in an Environment
* [FetchPublicationInEnvironment](#fetchpublicationinenvironment) - Get a Publication in an Environment
* [DeletePublicationInEnvironment](#deletepublicationinenvironment) - Delete Publication in an Environment
...
## PublishAPIToPortalInEnvironment
...
<!-- UsageSnippet language="go" operationID="publish-api-to-portal-in-environment" method="put" path="/v3/apis/{apiId}/environments/{environmentId}/publications/{portalId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.APIPublication.PublishAPIToPortalInEnvironment(ctx, operations.PublishAPIToPortalInEnvironmentRequest{
        APIID: "9f5061ce-78f6-4452-9108-ad7c02821fd5",
...
| ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                                  | [context.Context](https://pkg.go.dev/context#Context)                                                                  | :heavy_check_mark:                                                                                                     | The context to use for the request.                                                                                    |
| `request`                                                                                                              | [operations.PublishAPIToPortalInEnvironmentRequest](../../models/operations/publishapitoportalinenvironmentrequest.md) | :heavy_check_mark:                                                                                                     | The request object to use for the request.                                                                             |
| `opts`                                                                                                                 | [][operations.Option](../../models/operations/option.md)                                                               | :heavy_minus_sign:                                                                                                     | The options for this request.                                                                                          |

### Response

**[*operations.PublishAPIToPortalInEnvironmentResponse](../../models/operations/publishapitoportalinenvironmentresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="fetch-publication-in-environment" method="get" path="/v3/apis/{apiId}/environments/{environmentId}/publications/{portalId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.APIPublication.FetchPublicationInEnvironment(ctx, operations.FetchPublicationInEnvironmentRequest{
        APIID: "9f5061ce-78f6-4452-9108-ad7c02821fd5",
        EnvironmentID: "9ec7615a-288b-4a0a-b6a1-e0c49be23854",
        PortalID: "f32d905a-ed33-46a3-a093-d8f536af9a8a",
    })
...
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| `ctx`                                                                                                              | [context.Context](https://pkg.go.dev/context#Context)                                                              | :heavy_check_mark:                                                                                                 | The context to use for the request.                                                                                |
| `request`                                                                                                          | [operations.FetchPublicationInEnvironmentRequest](../../models/operations/fetchpublicationinenvironmentrequest.md) | :heavy_check_mark:                                                                                                 | The request object to use for the request.                                                                         |
| `opts`                                                                                                             | [][operations.Option](../../models/operations/option.md)                                                           | :heavy_minus_sign:                                                                                                 | The options for this request.                                                                                      |

### Response

**[*operations.FetchPublicationInEnvironmentResponse](../../models/operations/fetchpublicationinenvironmentresponse.md), error**
...
## DeletePublicationInEnvironment
...
<!-- UsageSnippet language="go" operationID="delete-publication-in-environment" method="delete" path="/v3/apis/{apiId}/environments/{environmentId}/publications/{portalId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.APIPublication.DeletePublicationInEnvironment(ctx, operations.DeletePublicationInEnvironmentRequest{
        APIID: "9f5061ce-78f6-4452-9108-ad7c02821fd5",
        EnvironmentID: "9ec7615a-288b-4a0a-b6a1-e0c49be23854",
        PortalID: "f32d905a-ed33-46a3-a093-d8f536af9a8a",
    })
...
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                                | [context.Context](https://pkg.go.dev/context#Context)                                                                | :heavy_check_mark:                                                                                                   | The context to use for the request.                                                                                  |
| `request`                                                                                                            | [operations.DeletePublicationInEnvironmentRequest](../../models/operations/deletepublicationinenvironmentrequest.md) | :heavy_check_mark:                                                                                                   | The request object to use for the request.                                                                           |
| `opts`                                                                                                               | [][operations.Option](../../models/operations/option.md)                                                             | :heavy_minus_sign:                                                                                                   | The options for this request.                                                                                        |

### Response

**[*operations.DeletePublicationInEnvironmentResponse](../../models/operations/deletepublicationinenvironmentresponse.md), error**
