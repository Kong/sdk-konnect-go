        ...
        components.AIGatewayMCPServerUpstreamServer{
            ...
            Config: components.AIGatewayMCPServerUpstreamServerConfig{
                ...
                Server: &components.AIGatewayMCPServerUpstreamServerServerConfig{
                    ForwardClientHeaders: sdkkonnectgo.Pointer(true),
                    Session: &components.AIGatewayMCPServerUpstreamServerServerConfigSession{
                        Managed: sdkkonnectgo.Pointer(true),
                        Redis: &components.AIGatewayRedisCloudConfiguration{
                            ...
                            Host: sdkkonnectgo.Pointer("127.0.0.1"),
                            Port: sdkkonnectgo.Pointer(components.CreatePortInteger(
                                6379,
                            )),
                            ReadTimeout: sdkkonnectgo.Pointer[int64](2000),
                            SendTimeout: sdkkonnectgo.Pointer[int64](2000),
                            Ssl: sdkkonnectgo.Pointer(true),
                            SslVerify: sdkkonnectgo.Pointer(true),
                        },
                        SessionTTL: sdkkonnectgo.Pointer[int64](86400),
                    },
                    Timeout: sdkkonnectgo.Pointer[int64](10000),
                    PreserveUpstreamToolNames: sdkkonnectgo.Pointer(false),
                },
                URL: "https://mcp.internal.kongair.com",
                ToolsCacheTTLSeconds: 650989,
            },
