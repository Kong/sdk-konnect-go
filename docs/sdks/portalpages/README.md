...
func main() {
    ...
    res, err := s.PortalPages.ListPortalPages(ctx, operations.ListPortalPagesRequest{
...
func main() {
    ...
    res, err := s.PortalPages.CreatePortalPage(ctx, "f32d905a-ed33-46a3-a093-d8f536af9a8a", components.CreatePortalPageRequest{
...
func main() {
    ...
    res, err := s.PortalPages.GetPortalPage(ctx, "f32d905a-ed33-46a3-a093-d8f536af9a8a", "ebbac5b0-ac89-45c3-9d2e-c4542c657e79")
    if err != nil {
        log.Fatal(err)
    }
    if res.PortalPageResponse != nil {
...
func main() {
    ...
    res, err := s.PortalPages.UpdatePortalPage(ctx, operations.UpdatePortalPageRequest{
        PortalID: "f32d905a-ed33-46a3-a093-d8f536af9a8a",
...
func main() {
    ...
    res, err := s.PortalPages.DeletePortalPage(ctx, "f32d905a-ed33-46a3-a093-d8f536af9a8a", "ebbac5b0-ac89-45c3-9d2e-c4542c657e79")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.PortalPages.MovePortalPages(ctx, operations.MovePortalPagesRequest{
        PortalID: "f32d905a-ed33-46a3-a093-d8f536af9a8a",
        PageID: "ebbac5b0-ac89-45c3-9d2e-c4542c657e79",
