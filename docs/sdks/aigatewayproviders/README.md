...
<!-- UsageSnippet language="go" operationID="get-ai-gateway-provider" method="get" path="/v1/ai-gateways/{gatewayId}/providers/{providerId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.AIGatewayProviders.GetAiGatewayProvider(ctx, "bf138ba2-c9b1-4229-b268-04d9d8a6410b", "bf138ba2-c9b1-4229-b268-04d9d8a6410b")
    if err != nil {
        log.Fatal(err)
    }
    if res.AIGatewayProvider != nil {
...
| `ctx`                                                    | [context.Context](https://pkg.go.dev/context#Context)    | :heavy_check_mark:                                       | The context to use for the request.                      |                                                          |
| `gatewayID`                                              | `string`                                                 | :heavy_check_mark:                                       | The unique ID of the AI Gateway.                         | 5f9fd312-a987-4628-b4c5-bb4f4fddd5f7                     |
| `providerID`                                             | `string`                                                 | :heavy_check_mark:                                       | The unique ID of the AI Gateway provider.                | 5f9fd312-a987-4628-b4c5-bb4f4fddd5f7                     |
| `opts`                                                   | [][operations.Option](../../models/operations/option.md) | :heavy_minus_sign:                                       | The options for this request.                            |                                                          |
...
<!-- UsageSnippet language="go" operationID="update-ai-gateway-provider" method="put" path="/v1/ai-gateways/{gatewayId}/providers/{providerId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.AIGatewayProviders.UpdateAiGatewayProvider(ctx, operations.UpdateAiGatewayProviderRequest{
        GatewayID: "bf138ba2-c9b1-4229-b268-04d9d8a6410b",
        ProviderID: "bf138ba2-c9b1-4229-b268-04d9d8a6410b",
...
<!-- UsageSnippet language="go" operationID="delete-ai-gateway-provider" method="delete" path="/v1/ai-gateways/{gatewayId}/providers/{providerId}" -->
```go
package main
...
func main() {
    ...
    res, err := s.AIGatewayProviders.DeleteAiGatewayProvider(ctx, "bf138ba2-c9b1-4229-b268-04d9d8a6410b", "bf138ba2-c9b1-4229-b268-04d9d8a6410b")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
