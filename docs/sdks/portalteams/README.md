...
| `portalCreateTeamRequest`                                                                                                                     | [*components.PortalCreateTeamRequest](../../models/components/portalcreateteamrequest.md)                                                     | :heavy_minus_sign:                                                                                                                            | Create a team in a portal.                                                                                                                    | {<br/>"name": "IDM - Developers",<br/>"description": "The Identity Management (IDM) team.",<br/>"can_own_applications": false,<br/>"konnect_managed": false<br/>} |
| `opts`                                                                                                                                        | [][operations.Option](../../models/operations/option.md)                                                                                      | :heavy_minus_sign:                                                                                                                            | The options for this request.                                                                                                                 |                                                                                                                                               |
...
func main() {
    ...
    res, err := s.PortalTeams.UpdatePortalTeam(ctx, operations.UpdatePortalTeamRequest{
        ...
        PortalUpdateTeamRequest: &components.PortalUpdateTeamRequest{
            ...
            CanOwnApplications: sdkkonnectgo.Pointer(false),
        },
    })
    if err != nil {
        log.Fatal(err)
