# PortalResponseDefaultAPIVisibility
...
value := components.PortalResponseDefaultAPIVisibilityPublic

// Open enum: custom values can be created with a direct type cast
custom := components.PortalResponseDefaultAPIVisibility("custom_value")
```
