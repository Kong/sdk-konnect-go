...
| `AdvancedQueryDimensionsStatusCode`                | status_code                                        |
| `AdvancedQueryDimensionsStatusCodeGrouped`         | status_code_grouped                                |
| `AdvancedQueryDimensionsTime`                      | time                                               |
| `AdvancedQueryDimensionsUpstreamStatusCode`        | upstream_status_code                               |
| `AdvancedQueryDimensionsUpstreamStatusCodeGrouped` | upstream_status_code_grouped                       |