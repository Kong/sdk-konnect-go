...
value := components.AllFilterItemsFieldA2aContextID

// Open enum: custom values can be created with a direct type cast
custom := components.AllFilterItemsField("custom_value")
```
...
| Name                                           | Value                                          |
| ---------------------------------------------- | ---------------------------------------------- |
| `AllFilterItemsFieldA2aContextID`              | a2a_context_id                                 |
...
| `AllFilterItemsFieldAiResponseModel`           | ai_response_model                              |
| `AllFilterItemsFieldAPI`                       | api                                            |
| `AllFilterItemsFieldAPIPackage`                | api_package                                    |
