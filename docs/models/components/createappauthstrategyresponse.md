...
```go
switch createAppAuthStrategyResponse.Type {
	case components.CreateAppAuthStrategyResponseTypeKeyAuth:
		// createAppAuthStrategyResponse.AppAuthStrategyKeyAuthResponse is populated
	case components.CreateAppAuthStrategyResponseTypeOpenidConnect:
		// createAppAuthStrategyResponse.AppAuthStrategyOpenIDConnectResponse is populated
}
```
