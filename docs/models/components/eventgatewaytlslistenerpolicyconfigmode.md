# EventGatewayTLSListenerPolicyConfigMode
...
value := components.EventGatewayTLSListenerPolicyConfigModeRequired

// Open enum: custom values can be created with a direct type cast
custom := components.EventGatewayTLSListenerPolicyConfigMode("custom_value")
```
...
| Name                                               | Value                                              |
| -------------------------------------------------- | -------------------------------------------------- |
| `EventGatewayTLSListenerPolicyConfigModeRequired`  | required                                           |
| `EventGatewayTLSListenerPolicyConfigModeRequested` | requested                                          |