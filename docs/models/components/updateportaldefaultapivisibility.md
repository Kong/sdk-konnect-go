# UpdatePortalDefaultAPIVisibility
...
value := components.UpdatePortalDefaultAPIVisibilityPublic

// Open enum: custom values can be created with a direct type cast
custom := components.UpdatePortalDefaultAPIVisibility("custom_value")
```
