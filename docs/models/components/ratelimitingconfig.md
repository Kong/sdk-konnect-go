...
| `Duration`                                                                       | [components.Duration](../../models/components/duration.md)                       | :heavy_check_mark:                                                               | The timeframe to ensure that an application does not exceed the request limit.   |