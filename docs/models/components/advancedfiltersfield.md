...
| `AdvancedFiltersFieldStatusCode`                | status_code                                     |
| `AdvancedFiltersFieldStatusCodeGrouped`         | status_code_grouped                             |
| `AdvancedFiltersFieldUpstreamStatusCode`        | upstream_status_code                            |
| `AdvancedFiltersFieldUpstreamStatusCodeGrouped` | upstream_status_code_grouped                    |