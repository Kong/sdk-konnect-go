...
value := components.VirtualClusterAuthenticationOauthBearerMediationPassthrough

// Open enum: custom values can be created with a direct type cast
custom := components.VirtualClusterAuthenticationOauthBearerMediation("custom_value")
```
