...
```go
updateFeatureRequestUnitCost := components.CreateUpdateFeatureRequestUnitCostManual(metering.UnitCostBillingFeatureManualUnitCost{/* values here */})
```

### UnitCostBillingFeatureLLMUnitCost

```go
updateFeatureRequestUnitCost := components.CreateUpdateFeatureRequestUnitCostLlm(metering.UnitCostBillingFeatureLLMUnitCost{/* values here */})
```
