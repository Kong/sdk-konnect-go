...
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `Type`                                                                                   | [metering.BillingPriceGraduatedType](../../models/metering/billingpricegraduatedtype.md) | :heavy_check_mark:                                                                       | The type of the price.                                                                   |
| `Tiers`                                                                                  | [][metering.BillingPriceTier](../../models/metering/billingpricetier.md)                 | :heavy_check_mark:                                                                       | The tiers of the graduated price. At least one tier is required.                         |