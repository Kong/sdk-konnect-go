...
```go
alignment := components.CreateAlignmentSubscription(metering.BillingWorkflowCollectionAlignmentSubscription{/* values here */})
```

### BillingWorkflowCollectionAlignmentAnchored

```go
alignment := components.CreateAlignmentAnchored(metering.BillingWorkflowCollectionAlignmentAnchored{/* values here */})
```
