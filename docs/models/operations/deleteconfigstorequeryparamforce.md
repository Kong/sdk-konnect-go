# DeleteConfigStoreQueryParamForce
...
value := operations.DeleteConfigStoreQueryParamForceTrue
```
...
| Name                                    | Value                                   |
| --------------------------------------- | --------------------------------------- |
| `DeleteConfigStoreQueryParamForceTrue`  | true                                    |
| `DeleteConfigStoreQueryParamForceFalse` | false                                   |