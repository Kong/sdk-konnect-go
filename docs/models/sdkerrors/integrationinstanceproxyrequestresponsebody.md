...
```go
integrationInstanceProxyRequestResponseBody := sdkerrors.CreateIntegrationInstanceProxyRequestResponseBodyBadRequestError(sdkerrors.BadRequestError{/* values here */})
```

### IntegrationUnauthorizedError

```go
integrationInstanceProxyRequestResponseBody := sdkerrors.CreateIntegrationInstanceProxyRequestResponseBodyIntegrationUnauthorizedError(sdkerrors.IntegrationUnauthorizedError{/* values here */})
```
