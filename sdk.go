...
// Generated from OpenAPI doc version 3.13.0 and generator version 2.881.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.31.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.31.2 2.881.0 3.13.0 github.com/Kong/sdk-konnect-go",
