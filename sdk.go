...
// Generated from OpenAPI doc version 3.0.29 and generator version 2.737.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.13.1-alpha.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.13.1-alpha.1 2.737.0 3.0.29 github.com/Kong/sdk-konnect-go",
