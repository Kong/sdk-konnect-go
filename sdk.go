...
// Generated from OpenAPI doc version 3.13.0 and generator version 2.879.13
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.31.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.31.1 2.879.13 3.13.0 github.com/Kong/sdk-konnect-go",
