...
// Generated from OpenAPI doc version 3.0.31 and generator version 2.795.6
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.18.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.18.3 2.795.6 3.0.31 github.com/Kong/sdk-konnect-go",
