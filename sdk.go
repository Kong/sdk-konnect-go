...
// Generated from OpenAPI doc version 3.0.31 and generator version 2.799.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.19.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.19.1 2.799.0 3.0.31 github.com/Kong/sdk-konnect-go",
