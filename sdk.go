...
// Generated from OpenAPI doc version 3.15.0 and generator version 2.926.8
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.53.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.53.0 2.926.8 3.15.0 github.com/Kong/sdk-konnect-go",
