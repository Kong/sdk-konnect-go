...
// Generated from OpenAPI doc version 3.0.26 and generator version 2.701.8
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.10.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.10.2 2.701.8 3.0.26 github.com/Kong/sdk-konnect-go",
