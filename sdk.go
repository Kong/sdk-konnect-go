...
// Generated from OpenAPI doc version 3.0.30 and generator version 2.794.1
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.18.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.18.1 2.794.1 3.0.30 github.com/Kong/sdk-konnect-go",
