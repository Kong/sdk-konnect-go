...
// Generated from OpenAPI doc version 3.15.0 and generator version 2.918.4
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.46.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.46.0 2.918.4 3.15.0 github.com/Kong/sdk-konnect-go",
