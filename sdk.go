...
// Generated from OpenAPI doc version 3.0.29 and generator version 2.750.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.13.2-alpha.2 2.750.0 3.0.29 github.com/Kong/sdk-konnect-go",
