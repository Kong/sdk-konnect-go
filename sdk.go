...
// Generated from OpenAPI doc version 3.1.5 and generator version 2.845.15
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.25.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.1 2.845.15 3.1.5 github.com/Kong/sdk-konnect-go",
