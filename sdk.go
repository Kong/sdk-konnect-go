...
// Generated from OpenAPI doc version 3.14.0 and generator version 2.886.1
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.39.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.39.0 2.886.1 3.14.0 github.com/Kong/sdk-konnect-go",
