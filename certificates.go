...
func (s *Certificates) GetCertificate(ctx context.Context, controlPlaneID string, certificateID string, opts ...operations.Option) (*operations.GetCertificateResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
