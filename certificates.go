...
func (s *Certificates) ListCertificateInWorkspace(ctx context.Context, request operations.ListCertificateInWorkspaceRequest, opts ...operations.Option) (*operations.ListCertificateInWorkspaceResponse, error) {
	...
	res := &operations.ListCertificateInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListCertificateInWorkspaceResponseBody
