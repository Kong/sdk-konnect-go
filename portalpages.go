...
func newPortalPages(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PortalPages {
	return &PortalPages{
		rootSDK:          rootSDK,
...
func (s *PortalPages) ListPortalPages(ctx context.Context, request operations.ListPortalPagesRequest, opts ...operations.Option) (*operations.ListPortalPagesResponse, error) {
...
func (s *PortalPages) CreatePortalPage(ctx context.Context, portalID string, createPortalPageRequest components.CreatePortalPageRequest, opts ...operations.Option) (*operations.CreatePortalPageResponse, error) {
...
func (s *PortalPages) GetPortalPage(ctx context.Context, portalID string, pageID string, opts ...operations.Option) (*operations.GetPortalPageResponse, error) {
...
func (s *PortalPages) DeletePortalPage(ctx context.Context, portalID string, pageID string, opts ...operations.Option) (*operations.DeletePortalPageResponse, error) {
...
func (s *PortalPages) MovePortalPages(ctx context.Context, request operations.MovePortalPagesRequest, opts ...operations.Option) (*operations.MovePortalPagesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
