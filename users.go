...
func (s *Users) GetUser(ctx context.Context, userID string) (*operations.GetUserResponse, error) {
...
func (s *Users) DeleteUser(ctx context.Context, userID string) (*operations.DeleteUserResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
