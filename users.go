...
func (s *Users) GetUsersInternal(ctx context.Context, aid *string, opts ...operations.Option) (*operations.GetUsersInternalResponse, error) {
	request := operations.GetUsersInternalRequest{
		Aid: aid,
	}
	...
	baseURL := utils.ReplaceParameters(operations.GetUsersInternalServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/v3/internal/users")
	if err != nil {
	...
	res := &operations.GetUsersInternalResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.InternalUsers
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.InternalUsers = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Users) GetUser(ctx context.Context, userID string, opts ...operations.Option) (*operations.GetUserResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetUserServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
...
func (s *Users) UpdateUser(ctx context.Context, userID string, updateUser *components.UpdateUser, opts ...operations.Option) (*operations.UpdateUserResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.UpdateUserServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
...
func (s *Users) DeleteUser(ctx context.Context, userID string, opts ...operations.Option) (*operations.DeleteUserResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.DeleteUserServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
...
func (s *Users) DeleteUserMfas(ctx context.Context, userID string, opts ...operations.Option) (*operations.DeleteUserMfasResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.DeleteUserMfasServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/users/{userId}/mfa", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DeleteUserMfasResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
