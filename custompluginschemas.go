...
func (s *CustomPluginSchemas) CreatePluginSchemas(ctx context.Context, controlPlaneID string, createPluginSchemas *components.CreatePluginSchemas) (*operations.CreatePluginSchemasResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
