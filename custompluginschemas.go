...
// ListPluginSchemasInWorkspace - List Custom Plugin Schemas in a workspace
// Returns an array of custom plugin schemas associated with a workspace.
func (s *CustomPluginSchemas) ListPluginSchemasInWorkspace(ctx context.Context, request operations.ListPluginSchemasInWorkspaceRequest, opts ...operations.Option) (*operations.ListPluginSchemasInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/plugin-schemas", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "list-plugin-schemas-in-workspace",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.ListPluginSchemasInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// CreatePluginSchemasInWorkspace - Upload custom plugin schema in a workspace
// Upload a custom plugin schema associated with a workspace.
func (s *CustomPluginSchemas) CreatePluginSchemasInWorkspace(ctx context.Context, request operations.CreatePluginSchemasInWorkspaceRequest, opts ...operations.Option) (*operations.CreatePluginSchemasInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "create-plugin-schemas-in-workspace",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "CreatePluginSchemas", "json", `request:"mediaType=application/json"`)
	...
	res := &operations.CreatePluginSchemasInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// GetPluginSchemaInWorkspace - Get a custom plugin schema in a workspace
// Returns information about a custom plugin schema from a given name in a workspace.
func (s *CustomPluginSchemas) GetPluginSchemaInWorkspace(ctx context.Context, request operations.GetPluginSchemaInWorkspaceRequest, opts ...operations.Option) (*operations.GetPluginSchemaInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/plugin-schemas/{name}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get-plugin-schema-in-workspace",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.GetPluginSchemaInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// DeletePluginSchemasInWorkspace - Delete custom plugin schema in a workspace
// Delete an individual custom plugin schema in a workspace.
func (s *CustomPluginSchemas) DeletePluginSchemasInWorkspace(ctx context.Context, request operations.DeletePluginSchemasInWorkspaceRequest, opts ...operations.Option) (*operations.DeletePluginSchemasInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "delete-plugin-schemas-in-workspace",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.DeletePluginSchemasInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// UpdatePluginSchemasInWorkspace - Create or update a custom plugin schema in a workspace
// Create or update an individual custom plugin schema in a workspace.
func (s *CustomPluginSchemas) UpdatePluginSchemasInWorkspace(ctx context.Context, request operations.UpdatePluginSchemasInWorkspaceRequest, opts ...operations.Option) (*operations.UpdatePluginSchemasInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "update-plugin-schemas-in-workspace",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "CreatePluginSchemas", "json", `request:"mediaType=application/json"`)
	...
	res := &operations.UpdatePluginSchemasInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
