...
func (s *Roles) GetTeamRole(ctx context.Context, teamID string, roleID string, opts ...operations.Option) (*operations.GetTeamRoleResponse, error) {
	request := operations.GetTeamRoleRequest{
		TeamID: teamID,
		RoleID: roleID,
	}
	...
	baseURL := utils.ReplaceParameters(operations.GetTeamRoleServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
	...
	res := &operations.GetTeamRoleResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// Returns the assigned role for the specified ID.
func (s *Roles) GetUserRole(ctx context.Context, userID string, roleID string, opts ...operations.Option) (*operations.GetUserRoleResponse, error) {
	request := operations.GetUserRoleRequest{
		UserID: userID,
		RoleID: roleID,
	}
	...
	baseURL := utils.ReplaceParameters(operations.GetUserRoleServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}
	...
	res := &operations.GetUserRoleResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
