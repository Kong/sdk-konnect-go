...
// Create a new SNI
func (s *SNIs) CreateSni(ctx context.Context, controlPlaneID string, createSNI components.CreateSNI) (*operations.CreateSniResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *SNIs) GetSni(ctx context.Context, controlPlaneID string, sniID string) (*operations.GetSniResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "get-sni",
		OAuth2Scopes:   []string{},
