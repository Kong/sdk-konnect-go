...
func newInvites(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Invites {
	return &Invites{
		rootSDK:          rootSDK,
...
func (s *Invites) InviteUser(ctx context.Context, request *components.InviteUser, opts ...operations.Option) (*operations.InviteUserResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.InviteUserServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/v3/invites")
	if err != nil {
