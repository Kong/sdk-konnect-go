...
type APISpecsPreview struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAPISpecsPreview(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *APISpecsPreview {
	return &APISpecsPreview{
		rootSDK:          rootSDK,
...
func (s *APISpecsPreview) PreviewAPISpec(ctx context.Context, request components.PreviewCatalogServiceAPISpec, opts ...operations.Option) (*operations.PreviewAPISpecResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/api-specs/preview")
	if err != nil {
	...
	res := &operations.PreviewAPISpecResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			res.APISpecContentsPreview = &out
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/yaml`):
			...
			out := string(rawBody)
			res.APISpecContentsPreviewYaml = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
