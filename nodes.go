...
func newNodes(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Nodes {
	return &Nodes{
		rootSDK:          rootSDK,
...
func (s *Nodes) UpsertNode(ctx context.Context, request operations.UpsertNodeRequest, opts ...operations.Option) (*operations.UpsertNodeResponse, error) {
	...
	res := &operations.UpsertNodeResponse{
