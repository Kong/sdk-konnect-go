...
func (s *Services) SearchServicesInWorkspace(ctx context.Context, request operations.SearchServicesInWorkspaceRequest, opts ...operations.Option) (*operations.SearchServicesInWorkspaceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/services/search", request, nil)
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "search-services-in-workspace",
		OAuth2Scopes:     nil,
	...
	res := &operations.SearchServicesInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.SearchServicesInWorkspaceResponseBody
...
// Search Services
func (s *Services) SearchServices(ctx context.Context, request operations.SearchServicesRequest, opts ...operations.Option) (*operations.SearchServicesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/services/search", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.SearchServicesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Services) ListServiceInWorkspace(ctx context.Context, request operations.ListServiceInWorkspaceRequest, opts ...operations.Option) (*operations.ListServiceInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.ListServiceInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListServiceInWorkspaceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
