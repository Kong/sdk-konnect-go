...
func (s *CatalogIntegrations) CreateCatalogIntegration(ctx context.Context, request components.CreateCatalogIntegration, opts ...operations.Option) (*operations.CreateCatalogIntegrationResponse, error) {
	...
	res := &operations.CreateCatalogIntegrationResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CatalogIntegration
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CatalogIntegration = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *CatalogIntegrations) GetCatalogIntegration(ctx context.Context, integration string, opts ...operations.Option) (*operations.GetCatalogIntegrationResponse, error) {
	request := operations.GetCatalogIntegrationRequest{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/integrations/{integration}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetCatalogIntegrationResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *CatalogIntegrations) UpdateCatalogIntegration(ctx context.Context, integration string, updateCatalogIntegration components.UpdateCatalogIntegration, opts ...operations.Option) (*operations.UpdateCatalogIntegrationResponse, error) {
	request := operations.UpdateCatalogIntegrationRequest{
		Integration:              integration,
		UpdateCatalogIntegration: updateCatalogIntegration,
	}
	...
	res := &operations.UpdateCatalogIntegrationResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *CatalogIntegrations) DeleteCatalogIntegration(ctx context.Context, integration string, opts ...operations.Option) (*operations.DeleteCatalogIntegrationResponse, error) {
	request := operations.DeleteCatalogIntegrationRequest{
		Integration: integration,
	}
	...
	res := &operations.DeleteCatalogIntegrationResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
