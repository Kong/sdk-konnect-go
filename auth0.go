...
func newAuth0(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Auth0 {
	return &Auth0{
		rootSDK:          rootSDK,
...
func (s *Auth0) PostAuth0UserMfaSettingsInternal(ctx context.Context, request components.GetMFASettingsRequest, opts ...operations.Option) (*operations.PostAuth0UserMfaSettingsInternalResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.PostAuth0UserMfaSettingsInternalServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/v3/internal/auth0/users/mfa-settings")
	if err != nil {
	...
	res := &operations.PostAuth0UserMfaSettingsInternalResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetMFASettingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetMFASettingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
