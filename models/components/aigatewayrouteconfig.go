...
func (a AIGatewayRouteConfig) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AIGatewayRouteConfig) UnmarshalJSON(data []byte) error {
...
func (a *AIGatewayRouteConfig) GetHosts() []string {
	if a == nil {
		return nil
	}
	return a.Hosts
...
func (a *AIGatewayRouteConfig) GetHTTPSRedirectStatusCode() *int64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayRouteConfig) GetMethods() []string {
	if a == nil {
		return nil
	}
	return a.Methods
...
func (a *AIGatewayRouteConfig) GetPreserveHost() *bool {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayRouteConfig) GetProtocols() []string {
	if a == nil {
		return nil
	}
	return a.Protocols
...
func (a *AIGatewayRouteConfig) GetRegexPriority() *int64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayRouteConfig) GetRequestBuffering() *bool {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayRouteConfig) GetResponseBuffering() *bool {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayRouteConfig) GetTags() []string {
	if a == nil {
		return nil
	}
	return a.Tags
