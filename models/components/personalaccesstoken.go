...
func (p *PersonalAccessToken) GetRevokedBy() optionalnullable.OptionalNullable[string] {
	if p == nil {
		return nil
	}
	return p.RevokedBy
...
func (p *PersonalAccessToken) GetLastUsedAt() optionalnullable.OptionalNullable[time.Time] {
	if p == nil {
		return nil
	}
	return p.LastUsedAt
...
func (p *PersonalAccessToken) GetRevokedAt() optionalnullable.OptionalNullable[time.Time] {
	if p == nil {
		return nil
	}
	return p.RevokedAt
