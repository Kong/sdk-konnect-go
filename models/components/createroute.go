...
type CreateRoute struct {
	...
	HTTPSRedirectStatusCode *CreateRouteHTTPSRedirectStatusCode `default:"426" json:"https_redirect_status_code"`
	...
	PathHandling *CreateRoutePathHandling `default:"v0" json:"path_handling"`
...
func (o *CreateRoute) GetHeaders() map[string]any {
	if o == nil {
		return nil
	}
	return o.Headers
