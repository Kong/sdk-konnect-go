...
// RouteWithoutParents - The request schema for the create route's request.
type RouteWithoutParents struct {
	...
	HTTPSRedirectStatusCode *RouteWithoutParentsHTTPSRedirectStatusCode `default:"426" json:"https_redirect_status_code"`
	...
	PathHandling *RouteWithoutParentsPathHandling `default:"v0" json:"path_handling"`
...
func (r RouteWithoutParents) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(r, "", false)
}

func (r *RouteWithoutParents) UnmarshalJSON(data []byte) error {
