...
func (a *AIGatewayTargetLlama2Config) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetLlama2Config) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetLlama2Config) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
