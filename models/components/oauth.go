...
func (o *OAuthConfig1) GetGrantType() GrantType {
	if o == nil {
		return GrantType("")
	}
	return o.GrantType
...
// OAuth - Defines the OAuth 2.0 authorization strategy used by an integration.
...
func (o *OAuth) GetOverridableConfig() []OverridableConfig {
	if o == nil {
		return nil
	}
...
func (o *OAuth) GetConfig() OAuthConfig1 {
	if o == nil {
		return OAuthConfig1{}
	}
	return o.Config
