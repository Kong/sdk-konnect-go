...
func (p *PartialRedisEe) GetCreatedAt() optionalnullable.OptionalNullable[int64] {
	if p == nil {
		return nil
	}
	return p.CreatedAt
...
func (p *PartialRedisEe) GetID() optionalnullable.OptionalNullable[string] {
	if p == nil {
		return nil
	}
	return p.ID
...
func (p *PartialRedisEe) GetName() optionalnullable.OptionalNullable[string] {
	if p == nil {
		return nil
	}
	return p.Name
...
func (p *PartialRedisEe) GetTags() optionalnullable.OptionalNullable[[]string] {
	if p == nil {
		return nil
	}
	return p.Tags
...
func (p *PartialRedisEe) GetUpdatedAt() optionalnullable.OptionalNullable[int64] {
	if p == nil {
		return nil
	}
	return p.UpdatedAt
