...
// CreateVaultConfig - The configuration properties for the Vault which can be found on the vaults' documentation page.
...
type CreateVault struct {
	...
	Config *CreateVaultConfig `json:"config,omitempty"`
...
func (o *CreateVault) GetConfig() *CreateVaultConfig {
	if o == nil {
		return nil
	}
	return o.Config
