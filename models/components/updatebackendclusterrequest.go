...
func (u *UpdateBackendClusterRequest) GetAuthenticationSaslAwsIam() *BackendClusterAuthenticationSaslAwsIam {
	return u.GetAuthentication().BackendClusterAuthenticationSaslAwsIam
}
