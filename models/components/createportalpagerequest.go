...
type CreatePortalPageRequest struct {
	...
	//
	ParentPageID optionalnullable.OptionalNullable[string] `json:"parent_page_id,omitempty"`
}
...
func (c *CreatePortalPageRequest) GetParentPageID() optionalnullable.OptionalNullable[string] {
	if c == nil {
		return nil
	}
