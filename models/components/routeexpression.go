...
// RouteExpressionInput - Route entities define rules to match client requests. Each Route is associated with a Service, and a Service may have multiple Routes associated to it. Every request matching a given Route will be proxied to its associated Service. The combination of Routes and Services (and the separation of concerns between them) offers a powerful routing mechanism with which it is possible to define fine-grained entry-points in Kong leading to different upstream services of your infrastructure. You need at least one matching rule that applies to the protocol being matched by the Route.
type RouteExpressionInput struct {
	// Use Router Expression to perform route match. This option is only available when `router_flavor` is set to `expressions`.
	Expression *string `json:"expression,omitempty"`
	// The status code Kong responds with when all properties of a Route match except the protocol i.e. if the protocol of the request is `HTTP` instead of `HTTPS`. `Location` header is injected by Kong if the field is set to 301, 302, 307 or 308. Note: This config applies only if the Route is configured to only accept the `https` protocol.
	HTTPSRedirectStatusCode *RouteExpressionHTTPSRedirectStatusCode `json:"https_redirect_status_code,omitempty"`
...
func (o *RouteExpressionInput) GetExpression() *string {
	if o == nil {
		return nil
	}
	return o.Expression
...
func (o *RouteExpressionInput) GetHTTPSRedirectStatusCode() *RouteExpressionHTTPSRedirectStatusCode {
	if o == nil {
		return nil
	}
	return o.HTTPSRedirectStatusCode
...
func (o *RouteExpressionInput) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
func (o *RouteExpressionInput) GetName() *string {
	if o == nil {
		return nil
	}
	return o.Name
...
func (o *RouteExpressionInput) GetPathHandling() *RouteExpressionPathHandling {
	if o == nil {
		return nil
	}
	return o.PathHandling
...
func (o *RouteExpressionInput) GetPreserveHost() *bool {
	if o == nil {
		return nil
	}
	return o.PreserveHost
...
func (o *RouteExpressionInput) GetPriority() *int64 {
	if o == nil {
		return nil
	}
	return o.Priority
...
func (o *RouteExpressionInput) GetProtocols() []RouteExpressionProtocols {
	if o == nil {
		return nil
	}
	return o.Protocols
...
func (o *RouteExpressionInput) GetRequestBuffering() *bool {
	if o == nil {
		return nil
	}
	return o.RequestBuffering
...
func (o *RouteExpressionInput) GetResponseBuffering() *bool {
	if o == nil {
		return nil
	}
	return o.ResponseBuffering
...
func (o *RouteExpressionInput) GetService() *RouteExpressionService {
	if o == nil {
		return nil
	}
	return o.Service
...
func (o *RouteExpressionInput) GetStripPath() *bool {
	if o == nil {
		return nil
	}
	return o.StripPath
...
func (o *RouteExpressionInput) GetTags() []string {
	if o == nil {
		return nil
	}
	return o.Tags
