...
type EventGatewayListenerPolicy struct {
	...
	ParentPolicyID optionalnullable.OptionalNullable[string] `json:"parent_policy_id,omitempty"`
...
func (e *EventGatewayListenerPolicy) GetParentPolicyID() optionalnullable.OptionalNullable[string] {
	if e == nil {
		return nil
	}
