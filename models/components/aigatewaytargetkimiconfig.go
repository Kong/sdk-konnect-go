...
func (a *AIGatewayTargetKimiConfig) GetCacheReadCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetKimiConfig) GetCacheWriteCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetKimiConfig) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetKimiConfig) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetKimiConfig) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetKimiConfig) GetCacheWriteCostList() []AIGatewayCacheWriteCost {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetKimiConfig) GetContextWindowFactor() []AIGatewayContextWindowFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetKimiConfig) GetServiceTierFactor() []AIGatewayServiceTierFactor {
	if a == nil {
		return nil
	}
