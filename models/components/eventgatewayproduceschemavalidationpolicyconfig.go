...
type EventGatewayProduceSchemaValidationPolicyConfig struct {
	EventGatewayProduceSchemaValidationPolicySchemaRegistryConfig *EventGatewayProduceSchemaValidationPolicySchemaRegistryConfig `queryParam:"inline,name=EventGatewayProduceSchemaValidationPolicyConfig" union:"member"`
	EventGatewayProduceSchemaValidationPolicyJSONConfig           *EventGatewayProduceSchemaValidationPolicyJSONConfig           `queryParam:"inline,name=EventGatewayProduceSchemaValidationPolicyConfig" union:"member"`
