...
type Target struct {
	...
	Upstream optionalnullable.OptionalNullable[TargetUpstream] `json:"upstream,omitempty"`
...
func (t *Target) GetCreatedAt() optionalnullable.OptionalNullable[float64] {
	if t == nil {
		return nil
	}
	return t.CreatedAt
...
func (t *Target) GetFailover() optionalnullable.OptionalNullable[bool] {
	if t == nil {
		return nil
	}
	return t.Failover
...
func (t *Target) GetID() optionalnullable.OptionalNullable[string] {
	if t == nil {
		return nil
	}
	return t.ID
...
func (t *Target) GetTags() optionalnullable.OptionalNullable[[]string] {
	if t == nil {
		return nil
	}
	return t.Tags
...
func (t *Target) GetUpdatedAt() optionalnullable.OptionalNullable[float64] {
	if t == nil {
		return nil
	}
	return t.UpdatedAt
...
func (t *Target) GetUpstream() optionalnullable.OptionalNullable[TargetUpstream] {
	if t == nil {
		return nil
	}
	return t.Upstream
...
func (t *Target) GetWeight() optionalnullable.OptionalNullable[int64] {
	if t == nil {
		return nil
	}
	return t.Weight
