...
type AIGatewayMCPServerPassthroughListenerResponse struct {
	...
	TokenVault *AIGatewayTokenVaultOutput `json:"token_vault,omitempty"`
...
func (a *AIGatewayMCPServerPassthroughListenerResponse) GetTokenVault() *AIGatewayTokenVaultOutput {
	if a == nil {
		return nil
	}
	return a.TokenVault
