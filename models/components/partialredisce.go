...
func (p *PartialRedisCe) GetCreatedAt() optionalnullable.OptionalNullable[int64] {
	if p == nil {
		return nil
	}
	return p.CreatedAt
...
func (p *PartialRedisCe) GetID() optionalnullable.OptionalNullable[string] {
	if p == nil {
		return nil
	}
	return p.ID
...
func (p *PartialRedisCe) GetName() optionalnullable.OptionalNullable[string] {
	if p == nil {
		return nil
	}
	return p.Name
...
func (p *PartialRedisCe) GetTags() optionalnullable.OptionalNullable[[]string] {
	if p == nil {
		return nil
	}
	return p.Tags
...
func (p *PartialRedisCe) GetUpdatedAt() optionalnullable.OptionalNullable[int64] {
	if p == nil {
		return nil
	}
	return p.UpdatedAt
