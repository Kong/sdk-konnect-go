...
type NetworkStateFieldEqualsFilter struct {
	NetworkState                      *NetworkState                      `queryParam:"inline" union:"member"`
	NetworkStateFieldEqualsComparison *NetworkStateFieldEqualsComparison `queryParam:"inline" union:"member"`
