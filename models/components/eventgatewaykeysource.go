...
type EventGatewayKeySource struct {
	EventGatewayAWSKeySource    *EventGatewayAWSKeySource    `queryParam:"inline,name=EventGatewayKeySource" union:"member"`
	EventGatewayStaticKeySource *EventGatewayStaticKeySource `queryParam:"inline,name=EventGatewayKeySource" union:"member"`
