...
func (s *SNIWithoutParents) GetCreatedAt() optionalnullable.OptionalNullable[int64] {
	if s == nil {
		return nil
	}
	return s.CreatedAt
...
func (s *SNIWithoutParents) GetID() optionalnullable.OptionalNullable[string] {
	if s == nil {
		return nil
	}
	return s.ID
...
func (s *SNIWithoutParents) GetTags() optionalnullable.OptionalNullable[[]string] {
	if s == nil {
		return nil
	}
	return s.Tags
...
func (s *SNIWithoutParents) GetUpdatedAt() optionalnullable.OptionalNullable[int64] {
	if s == nil {
		return nil
	}
	return s.UpdatedAt
