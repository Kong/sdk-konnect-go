...
type UpdateAppAuthStrategyRequest struct {
	...
	DcrProviderID optionalnullable.OptionalNullable[string]             `json:"dcr_provider_id,omitempty"`
...
func (u *UpdateAppAuthStrategyRequest) GetLabels() optionalnullable.OptionalNullable[map[string]*string] {
	if u == nil {
		return nil
	}
	return u.Labels
...
func (u *UpdateAppAuthStrategyRequest) GetDcrProviderID() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
