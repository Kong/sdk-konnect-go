...
type PortalCustomization struct {
	...
	CSS          optionalnullable.OptionalNullable[string] `json:"css,omitempty"`
	Menu         *Menu                                     `json:"menu,omitempty"`
	SpecRenderer *SpecRenderer                             `json:"spec_renderer,omitempty"`
	Robots       optionalnullable.OptionalNullable[string] `json:"robots,omitempty"`
}
...
func (p *PortalCustomization) GetCSS() optionalnullable.OptionalNullable[string] {
	if p == nil {
		return nil
	}
	return p.CSS
...
func (p *PortalCustomization) GetRobots() optionalnullable.OptionalNullable[string] {
	if p == nil {
		return nil
	}
	return p.Robots
