...
func (a *AIGatewayTargetDeepseekConfig) GetCacheReadCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetDeepseekConfig) GetCacheWriteCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetDeepseekConfig) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetDeepseekConfig) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetDeepseekConfig) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetDeepseekConfig) GetCacheWriteCostList() []AIGatewayCacheWriteCost {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetDeepseekConfig) GetContextWindowFactor() []AIGatewayContextWindowFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetDeepseekConfig) GetServiceTierFactor() []AIGatewayServiceTierFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetDeepseekConfig) GetType() string {
	return "deepseek"
}
