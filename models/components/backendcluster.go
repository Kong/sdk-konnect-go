...
func (b *BackendCluster) GetAuthenticationSaslAwsIam() *BackendClusterAuthenticationSaslAwsIam {
	return b.GetAuthentication().BackendClusterAuthenticationSaslAwsIam
}
