...
func (a *AIGatewayTargetAnthropicConfig) GetCacheReadCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetAnthropicConfig) GetCacheWriteCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetAnthropicConfig) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetAnthropicConfig) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetAnthropicConfig) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetAnthropicConfig) GetCacheWriteCostList() []AIGatewayCacheWriteCost {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetAnthropicConfig) GetContextWindowFactor() []AIGatewayContextWindowFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetAnthropicConfig) GetServiceTierFactor() []AIGatewayServiceTierFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetAnthropicConfig) GetType() string {
	return "anthropic"
}
