...
func (a *AIGatewayTargetHuggingfaceConfig) GetCacheReadCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetHuggingfaceConfig) GetCacheWriteCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetHuggingfaceConfig) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetHuggingfaceConfig) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetHuggingfaceConfig) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetHuggingfaceConfig) GetCacheWriteCostList() []AIGatewayCacheWriteCost {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetHuggingfaceConfig) GetContextWindowFactor() []AIGatewayContextWindowFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetHuggingfaceConfig) GetServiceTierFactor() []AIGatewayServiceTierFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetHuggingfaceConfig) GetType() string {
	return "huggingface"
}
