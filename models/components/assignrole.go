...
func (e *EntityTypeName) IsExact() bool {
	if e != nil {
		switch *e {
		case "Add Ons", "APIs", "API Products", "Application Auth Strategies", "Audit Logs", "Control Planes", "Dashboards", "DCR Providers", "Environments", "Mesh Control Planes", "Networks", "Portals", "Reports", "Service Hub", "Auth Servers":
			return true
		}
	}
	return false
