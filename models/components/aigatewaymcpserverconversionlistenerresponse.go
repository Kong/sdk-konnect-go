...
func (a *AIGatewayMCPServerConversionListenerResponseAIGatewayMCPServerKongListenerConfig) GetAllowedVersions() []AllowedVersions {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayMCPServerConversionListenerResponse) GetTokenVault() *AIGatewayTokenVaultOutput {
	if a == nil {
		return nil
	}
	return a.TokenVault
