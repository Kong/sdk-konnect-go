...
type CustomDomain struct {
	...
	//
	CertificateID optionalnullable.OptionalNullable[string] `json:"certificate_id,omitempty"`
	...
	//
	SniID optionalnullable.OptionalNullable[string] `json:"sni_id,omitempty"`
...
func (c *CustomDomain) GetCertificateID() optionalnullable.OptionalNullable[string] {
	if c == nil {
		return nil
	}
...
func (c *CustomDomain) GetSniID() optionalnullable.OptionalNullable[string] {
	if c == nil {
		return nil
	}
	return c.SniID
