...
func (p *PluginSchemasItem) GetName() *string {
	if p == nil {
		return nil
	}
	return p.Name
...
func (p *PluginSchemasItem) GetCreatedAt() *int64 {
	if p == nil {
		return nil
	}
	return p.CreatedAt
...
func (p *PluginSchemasItem) GetUpdatedAt() *int64 {
	if p == nil {
		return nil
	}
	return p.UpdatedAt
...
func (p *PluginSchemas) GetItem() *PluginSchemasItem {
	if p == nil {
		return nil
	}
	return p.Item
