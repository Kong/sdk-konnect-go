...
func (v *Vault) GetConfig() optionalnullable.OptionalNullable[map[string]any] {
	if v == nil {
		return nil
	}
	return v.Config
...
func (v *Vault) GetCreatedAt() optionalnullable.OptionalNullable[int64] {
	if v == nil {
		return nil
	}
	return v.CreatedAt
...
func (v *Vault) GetDescription() optionalnullable.OptionalNullable[string] {
	if v == nil {
		return nil
	}
...
func (v *Vault) GetID() optionalnullable.OptionalNullable[string] {
	if v == nil {
		return nil
	}
	return v.ID
...
func (v *Vault) GetTags() optionalnullable.OptionalNullable[[]string] {
	if v == nil {
		return nil
	}
	return v.Tags
...
func (v *Vault) GetUpdatedAt() optionalnullable.OptionalNullable[int64] {
	if v == nil {
		return nil
	}
	return v.UpdatedAt
