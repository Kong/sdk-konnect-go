...
type APIResponseSchema struct {
	...
	ImplementationMode optionalnullable.OptionalNullable[string] `json:"implementation_mode,omitempty"`
...
func (a *APIResponseSchema) GetDescription() optionalnullable.OptionalNullable[string] {
	if a == nil {
		return nil
	}
...
func (a *APIResponseSchema) GetImplementationMode() optionalnullable.OptionalNullable[string] {
	if a == nil {
		return nil
	}
