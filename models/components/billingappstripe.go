...
func (b *BillingAppStripeDefinition) GetCapabilities() []BillingAppCapability {
	if b == nil {
...
func (b *BillingAppStripeDefinition) GetInstallMethods() []BillingAppInstallMethods {
	if b == nil {
