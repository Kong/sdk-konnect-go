...
type VirtualClusterNamespaceIDSelector struct {
	VirtualClusterNamespaceIDSelectorGlob      *VirtualClusterNamespaceIDSelectorGlob      `queryParam:"inline,name=VirtualClusterNamespaceIdSelector" union:"member"`
	VirtualClusterNamespaceIDSelectorExactList *VirtualClusterNamespaceIDSelectorExactList `queryParam:"inline,name=VirtualClusterNamespaceIdSelector" union:"member"`
