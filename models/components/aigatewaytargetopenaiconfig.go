...
func (a *AIGatewayTargetOpenaiConfig) GetCacheReadCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOpenaiConfig) GetCacheWriteCost() *float64 {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOpenaiConfig) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOpenaiConfig) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOpenaiConfig) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOpenaiConfig) GetCacheWriteCostList() []AIGatewayCacheWriteCost {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOpenaiConfig) GetContextWindowFactor() []AIGatewayContextWindowFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOpenaiConfig) GetServiceTierFactor() []AIGatewayServiceTierFactor {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOpenaiConfig) GetType() string {
	return "openai"
}
