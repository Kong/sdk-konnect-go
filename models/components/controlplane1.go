...
// ControlPlane1 - The control plane object contains information about a Kong control plane.
...
func (c *ControlPlane1) GetID() string {
	if c == nil {
		return ""
	}
	return c.ID
...
func (c *ControlPlane1) GetName() string {
	if c == nil {
		return ""
	}
	return c.Name
...
func (c *ControlPlane1) GetConfig() ControlPlaneConfig {
	if c == nil {
...
func (c *ControlPlane1) GetCreatedAt() time.Time {
	if c == nil {
		return time.Time{}
	}
	return c.CreatedAt
...
func (c *ControlPlane1) GetUpdatedAt() time.Time {
	if c == nil {
		return time.Time{}
	}
	return c.UpdatedAt
