...
type Upstream struct {
	...
	Algorithm optionalnullable.OptionalNullable[UpstreamAlgorithm] `default:"round-robin" json:"algorithm"`
	// If set, the certificate to be used as client certificate while TLS handshaking to the upstream server.
	ClientCertificate optionalnullable.OptionalNullable[UpstreamClientCertificate] `json:"client_certificate,omitempty"`
	...
	HashFallback optionalnullable.OptionalNullable[HashFallback] `default:"none" json:"hash_fallback"`
	// The header name to take the value from as hash input. Only required when `hash_fallback` is set to `header`.
	HashFallbackHeader optionalnullable.OptionalNullable[string] `json:"hash_fallback_header,omitempty"`
	...
	HashFallbackQueryArg optionalnullable.OptionalNullable[string] `json:"hash_fallback_query_arg,omitempty"`
	...
	HashFallbackURICapture optionalnullable.OptionalNullable[string] `json:"hash_fallback_uri_capture,omitempty"`
	// What to use as hashing input. Using `none` results in a weighted-round-robin scheme with no hashing.
	HashOn optionalnullable.OptionalNullable[HashOn] `default:"none" json:"hash_on"`
	...
	HashOnCookie optionalnullable.OptionalNullable[string] `json:"hash_on_cookie,omitempty"`
	// The cookie path to set in the response headers. Only required when `hash_on` or `hash_fallback` is set to `cookie`.
	HashOnCookiePath optionalnullable.OptionalNullable[string] `default:"/" json:"hash_on_cookie_path"`
	// The header name to take the value from as hash input. Only required when `hash_on` is set to `header`.
	HashOnHeader optionalnullable.OptionalNullable[string] `json:"hash_on_header,omitempty"`
	...
	HashOnQueryArg optionalnullable.OptionalNullable[string] `json:"hash_on_query_arg,omitempty"`
	// The name of the route URI capture to take the value from as hash input. Only required when `hash_on` is set to `uri_capture`.
	HashOnURICapture optionalnullable.OptionalNullable[string] `json:"hash_on_uri_capture,omitempty"`
	// The array of healthchecks.
	Healthchecks optionalnullable.OptionalNullable[Healthchecks] `json:"healthchecks,omitempty"`
	// The hostname to be used as `Host` header when proxying requests through Kong.
	HostHeader optionalnullable.OptionalNullable[string] `json:"host_header,omitempty"`
	...
	Slots optionalnullable.OptionalNullable[int64] `default:"10000" json:"slots"`
	// The cookie name to keep sticky sessions.
	StickySessionsCookie optionalnullable.OptionalNullable[string] `json:"sticky_sessions_cookie,omitempty"`
	// A string representing a URL path, such as /path/to/resource. Must start with a forward slash (/) and must not contain empty segments (i.e., two consecutive forward slashes).
	StickySessionsCookiePath optionalnullable.OptionalNullable[string] `default:"/" json:"sticky_sessions_cookie_path"`
	...
	UseSrvName optionalnullable.OptionalNullable[bool] `default:"false" json:"use_srv_name"`
}
...
func (u *Upstream) GetAlgorithm() optionalnullable.OptionalNullable[UpstreamAlgorithm] {
	if u == nil {
		return nil
	}
	return u.Algorithm
...
func (u *Upstream) GetClientCertificate() optionalnullable.OptionalNullable[UpstreamClientCertificate] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetCreatedAt() optionalnullable.OptionalNullable[int64] {
	if u == nil {
		return nil
	}
	return u.CreatedAt
...
func (u *Upstream) GetHashFallback() optionalnullable.OptionalNullable[HashFallback] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHashFallbackHeader() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHashFallbackQueryArg() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHashFallbackURICapture() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHashOn() optionalnullable.OptionalNullable[HashOn] {
	if u == nil {
		return nil
	}
	return u.HashOn
...
func (u *Upstream) GetHashOnCookie() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHashOnCookiePath() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHashOnHeader() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHashOnQueryArg() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHashOnURICapture() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHealthchecks() optionalnullable.OptionalNullable[Healthchecks] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetHostHeader() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
	return u.HostHeader
...
func (u *Upstream) GetID() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
	return u.ID
...
func (u *Upstream) GetSlots() optionalnullable.OptionalNullable[int64] {
	if u == nil {
		return nil
	}
	return u.Slots
...
func (u *Upstream) GetStickySessionsCookie() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetStickySessionsCookiePath() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *Upstream) GetTags() optionalnullable.OptionalNullable[[]string] {
	if u == nil {
		return nil
	}
	return u.Tags
...
func (u *Upstream) GetUpdatedAt() optionalnullable.OptionalNullable[int64] {
	if u == nil {
		return nil
	}
	return u.UpdatedAt
...
func (u *Upstream) GetUseSrvName() optionalnullable.OptionalNullable[bool] {
	if u == nil {
		return nil
	}
	return u.UseSrvName
