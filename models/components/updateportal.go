...
type UpdatePortal struct {
	...
	DefaultApplicationAuthStrategyID optionalnullable.OptionalNullable[string] `json:"default_application_auth_strategy_id,omitempty"`
...
func (u *UpdatePortal) GetDescription() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *UpdatePortal) GetDefaultApplicationAuthStrategyID() optionalnullable.OptionalNullable[string] {
	if u == nil {
		return nil
	}
...
func (u *UpdatePortal) GetLabels() optionalnullable.OptionalNullable[map[string]*string] {
	if u == nil {
		return nil
	}
	return u.Labels
