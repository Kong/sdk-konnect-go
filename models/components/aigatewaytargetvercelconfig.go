...
// AIGatewayTargetVercelConfig - Vercel AI Gateway-specific configuration for a model.
...
func (a *AIGatewayTargetVercelConfig) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetVercelConfig) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetVercelConfig) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
