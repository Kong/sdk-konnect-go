...
func (a *AIGatewayTargetOllamaConfig) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOllamaConfig) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetOllamaConfig) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
