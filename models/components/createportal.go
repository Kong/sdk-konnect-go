...
func (c *CreatePortal) GetDescription() optionalnullable.OptionalNullable[string] {
	if c == nil {
		return nil
	}
...
func (c *CreatePortal) GetDefaultApplicationAuthStrategyID() optionalnullable.OptionalNullable[string] {
	if c == nil {
		return nil
	}
...
func (c *CreatePortal) GetLabels() optionalnullable.OptionalNullable[map[string]*string] {
	if c == nil {
		return nil
	}
	return c.Labels
