...
func (a *AIGatewayTargetXaiConfig) GetInputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetXaiConfig) GetOutputCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetXaiConfig) GetCacheReadCostList() []AIGatewayModalCostList {
	if a == nil {
		return nil
	}
...
func (a *AIGatewayTargetXaiConfig) GetType() string {
	return "xai"
}
