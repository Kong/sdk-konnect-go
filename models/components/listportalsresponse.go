...
func (l *ListPortalsResponsePortal) GetDefaultAPIVisibility() PortalDefaultAPIVisibility {
	if l == nil {
...
func (l *ListPortalsResponsePortal) GetDefaultPageVisibility() PortalDefaultPageVisibility {
	if l == nil {
