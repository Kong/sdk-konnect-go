...
type CreateRouteWithoutParents struct {
	...
	// The status code Kong responds with when all properties of a Route match except the protocol i.e. if the protocol of the request is `HTTP` instead of `HTTPS`. `Location` header is injected by Kong if the field is set to 301, 302, 307 or 308. Note: This config applies only if the Route is configured to only accept the `https` protocol.
	HTTPSRedirectStatusCode *CreateRouteWithoutParentsHTTPSRedirectStatusCode `default:"426" json:"https_redirect_status_code"`
	...
	PathHandling *CreateRouteWithoutParentsPathHandling `default:"v0" json:"path_handling"`
...
func (c CreateRouteWithoutParents) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateRouteWithoutParents) UnmarshalJSON(data []byte) error {
...
func (o *CreateRouteWithoutParents) GetHeaders() map[string]any {
	if o == nil {
		return nil
	}
	return o.Headers
