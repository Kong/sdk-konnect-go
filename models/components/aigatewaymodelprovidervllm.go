...
func (a AIGatewayModelProviderVllmConfig) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AIGatewayModelProviderVllmConfig) UnmarshalJSON(data []byte) error {
...
func (a *AIGatewayModelProviderVllmConfig) GetAuth() AIGatewayModelProviderConfigAuthBasic {
	if a == nil {
...
type AIGatewayModelProviderVllm struct {
	...
	Config AIGatewayModelProviderVllmConfig `json:"config"`
}

func (a AIGatewayModelProviderVllm) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AIGatewayModelProviderVllm) UnmarshalJSON(data []byte) error {
...
func (a *AIGatewayModelProviderVllm) GetName() string {
	if a == nil {
		return ""
	}
	return a.Name
...
func (a *AIGatewayModelProviderVllm) GetLabels() map[string]string {
	if a == nil {
		return nil
	}
	return a.Labels
...
func (a *AIGatewayModelProviderVllm) GetManagedBy() map[string]string {
	if a == nil {
		return nil
	}
	return a.ManagedBy
...
func (a *AIGatewayModelProviderVllm) GetConfig() AIGatewayModelProviderVllmConfig {
	if a == nil {
		return AIGatewayModelProviderVllmConfig{}
	}
	return a.Config
}
