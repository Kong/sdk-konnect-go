...
type MCPResourceSourceRaw struct {
	...
	Config CommonAPIResourceConfigResponse `json:"config"`
}
...
func (m *MCPResourceSourceRaw) GetConfig() CommonAPIResourceConfigResponse {
	if m == nil {
		return CommonAPIResourceConfigResponse{}
	}
	return m.Config
}
