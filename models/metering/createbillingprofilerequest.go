...
// CreateBillingProfileRequestMeteringPayment - The payment app used for this workflow.
type CreateBillingProfileRequestMeteringPayment struct {
	// The ID of the app.
	ID string `json:"id"`
}

func (c *CreateBillingProfileRequestMeteringPayment) GetID() string {
	if c == nil {
		return ""
	}
	return c.ID
...
type CreateBillingProfileRequestApps struct {
	...
	Payment CreateBillingProfileRequestMeteringPayment `json:"payment"`
}
...
func (c *CreateBillingProfileRequestApps) GetPayment() CreateBillingProfileRequestMeteringPayment {
	if c == nil {
		return CreateBillingProfileRequestMeteringPayment{}
	}
	return c.Payment
}
