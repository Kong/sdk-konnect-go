...
type CreateServerlessCloudGatewayResponse struct {
	...
	ServerlessCloudGateway *components.ServerlessCloudGateway
}
...
func (o *CreateServerlessCloudGatewayResponse) GetServerlessCloudGateway() *components.ServerlessCloudGateway {
	if o == nil {
		return nil
	}
