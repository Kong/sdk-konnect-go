...
func (l *ListPluginInWorkspaceRequest) GetControlPlaneID() string {
	if l == nil {
		return ""
	}
...
func (l *ListPluginInWorkspaceResponseBody) GetData() []components.Plugin {
	if l == nil {
		return nil
	}
	return l.Data
