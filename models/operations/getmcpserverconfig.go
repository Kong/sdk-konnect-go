...
type GetMcpServerConfigRequest struct {
	// The ID of the MCP server.
	McpServerID string `pathParam:"style=simple,explode=false,name=mcpServerId"`
}

func (g *GetMcpServerConfigRequest) GetMcpServerID() string {
	if g == nil {
		return ""
	}
...
type GetMcpServerConfigResponse struct {
...
func (g *GetMcpServerConfigResponse) GetStatusCode() int {
	if g == nil {
		return 0
	}
	return g.StatusCode
...
func (g *GetMcpServerConfigResponse) GetRawResponse() *http.Response {
	if g == nil {
		return nil
	}
