...
func (g *GetHmacAuthWithConsumerRequest) GetConsumerIDForNestedEntities() string {
	if g == nil {
		return ""
	}
...
func (g *GetHmacAuthWithConsumerResponse) GetHMACAuth() *components.HMACAuth {
	if g == nil {
		return nil
	}
	return g.HMACAuth
