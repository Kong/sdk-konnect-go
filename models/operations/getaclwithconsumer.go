...
func (g *GetACLWithConsumerRequest) GetConsumerIDForNestedEntities() string {
	if g == nil {
		return ""
	}
...
func (g *GetACLWithConsumerResponse) GetACL() *components.ACL {
	if g == nil {
		return nil
	}
	return g.ACL
