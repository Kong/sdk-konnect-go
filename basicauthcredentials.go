...
func newBasicAuthCredentials(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *BasicAuthCredentials {
...
func (s *BasicAuthCredentials) ListBasicAuthInWorkspace(ctx context.Context, request operations.ListBasicAuthInWorkspaceRequest, opts ...operations.Option) (*operations.ListBasicAuthInWorkspaceResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/basic-auths", request, nil)
	if err != nil {
	...
	res := &operations.ListBasicAuthInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListBasicAuthInWorkspaceResponseBody
...
func (s *BasicAuthCredentials) GetBasicAuthInWorkspace(ctx context.Context, request operations.GetBasicAuthInWorkspaceRequest, opts ...operations.Option) (*operations.GetBasicAuthInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/basic-auths/{BasicAuthId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetBasicAuthInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *BasicAuthCredentials) ListBasicAuthWithConsumerInWorkspace(ctx context.Context, request operations.ListBasicAuthWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.ListBasicAuthWithConsumerInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.ListBasicAuthWithConsumerInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListBasicAuthWithConsumerInWorkspaceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *BasicAuthCredentials) UpsertBasicAuthWithConsumerInWorkspace(ctx context.Context, request operations.UpsertBasicAuthWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.UpsertBasicAuthWithConsumerInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.UpsertBasicAuthWithConsumerInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
