...
func newDPCertificates(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *DPCertificates {
...
func (s *DPCertificates) UpdateDataplaneCertificate(ctx context.Context, request operations.UpdateDataplaneCertificateRequest, opts ...operations.Option) (*operations.UpdateDataplaneCertificateResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.UpdateDataplaneCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
