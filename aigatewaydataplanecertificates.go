...
// AIGatewayDataPlaneCertificates - API related to the management of AI Gateway DataPlane Certificates.
type AIGatewayDataPlaneCertificates struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAIGatewayDataPlaneCertificates(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AIGatewayDataPlaneCertificates {
	return &AIGatewayDataPlaneCertificates{
		rootSDK:          rootSDK,
...
func (s *AIGatewayDataPlaneCertificates) ListAiGatewayDataPlaneCertificates(ctx context.Context, request operations.ListAiGatewayDataPlaneCertificatesRequest, opts ...operations.Option) (*operations.ListAiGatewayDataPlaneCertificatesResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/data-plane-certificates", request, nil)
	if err != nil {
	...
	res := &operations.ListAiGatewayDataPlaneCertificatesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListAIGatewayDataPlaneCertificatesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAIGatewayDataPlaneCertificatesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayDataPlaneCertificates) CreateAiGatewayDataPlaneCertificate(ctx context.Context, gatewayID string, createAIGatewayDataPlaneCertificateRequest *components.CreateAIGatewayDataPlaneCertificateRequest, opts ...operations.Option) (*operations.CreateAiGatewayDataPlaneCertificateResponse, error) {
	...
	res := &operations.CreateAiGatewayDataPlaneCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AIGatewayDataPlaneClientCertificate
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AIGatewayDataPlaneClientCertificate = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AIGatewayDataPlaneCertificates) GetAiGatewayDataPlaneCertificate(ctx context.Context, gatewayID string, certificateID string, opts ...operations.Option) (*operations.GetAiGatewayDataPlaneCertificateResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/ai-gateways/{gatewayId}/data-plane-certificates/{certificateId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetAiGatewayDataPlaneCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *AIGatewayDataPlaneCertificates) DeleteAiGatewayDataPlaneCertificate(ctx context.Context, gatewayID string, certificateID string, opts ...operations.Option) (*operations.DeleteAiGatewayDataPlaneCertificateResponse, error) {
	...
	res := &operations.DeleteAiGatewayDataPlaneCertificateResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
