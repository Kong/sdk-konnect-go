...
// Snippets - APIs related to Konnect Developer Portal Custom Snippets.
...
func newSnippets(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Snippets {
	return &Snippets{
		rootSDK:          rootSDK,
...
func (s *Snippets) ListPortalSnippets(ctx context.Context, request operations.ListPortalSnippetsRequest, opts ...operations.Option) (*operations.ListPortalSnippetsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/portals/{portalId}/snippets", request, nil)
	if err != nil {
	...
	res := &operations.ListPortalSnippetsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListPortalSnippetsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListPortalSnippetsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Snippets) CreatePortalSnippet(ctx context.Context, portalID string, createPortalSnippetRequest components.CreatePortalSnippetRequest, opts ...operations.Option) (*operations.CreatePortalSnippetResponse, error) {
	...
	res := &operations.CreatePortalSnippetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PortalSnippetResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PortalSnippetResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Snippets) GetPortalSnippet(ctx context.Context, portalID string, snippetID string, opts ...operations.Option) (*operations.GetPortalSnippetResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/portals/{portalId}/snippets/{snippetId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetPortalSnippetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Snippets) UpdatePortalSnippet(ctx context.Context, request operations.UpdatePortalSnippetRequest, opts ...operations.Option) (*operations.UpdatePortalSnippetResponse, error) {
	...
	res := &operations.UpdatePortalSnippetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Snippets) DeletePortalSnippet(ctx context.Context, portalID string, snippetID string, opts ...operations.Option) (*operations.DeletePortalSnippetResponse, error) {
	...
	res := &operations.DeletePortalSnippetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
