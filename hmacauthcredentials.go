...
func newHMACAuthCredentials(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *HMACAuthCredentials {
...
func (s *HMACAuthCredentials) ListHmacAuthWithConsumerInWorkspace(ctx context.Context, request operations.ListHmacAuthWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.ListHmacAuthWithConsumerInWorkspaceResponse, error) {
	...
	res := &operations.ListHmacAuthWithConsumerInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListHmacAuthWithConsumerInWorkspaceResponseBody
...
func (s *HMACAuthCredentials) UpsertHmacAuthWithConsumerInWorkspace(ctx context.Context, request operations.UpsertHmacAuthWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.UpsertHmacAuthWithConsumerInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.UpsertHmacAuthWithConsumerInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *HMACAuthCredentials) ListHmacAuthInWorkspace(ctx context.Context, request operations.ListHmacAuthInWorkspaceRequest, opts ...operations.Option) (*operations.ListHmacAuthInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/hmac-auths", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListHmacAuthInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListHmacAuthInWorkspaceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *HMACAuthCredentials) GetHmacAuthInWorkspace(ctx context.Context, request operations.GetHmacAuthInWorkspaceRequest, opts ...operations.Option) (*operations.GetHmacAuthInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/hmac-auths/{HMACAuthId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetHmacAuthInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *HMACAuthCredentials) ListHmacAuth(ctx context.Context, request operations.ListHmacAuthRequest, opts ...operations.Option) (*operations.ListHmacAuthResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/hmac-auths", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *HMACAuthCredentials) GetHmacAuth(ctx context.Context, hmacAuthID string, controlPlaneID string, opts ...operations.Option) (*operations.GetHmacAuthResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/hmac-auths/{HMACAuthId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
