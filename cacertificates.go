...
func (s *CACertificates) ListCaCertificateInWorkspace(ctx context.Context, request operations.ListCaCertificateInWorkspaceRequest, opts ...operations.Option) (*operations.ListCaCertificateInWorkspaceResponse, error) {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "list-ca_certificate-in-workspace",
	...
	res := &operations.ListCaCertificateInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListCaCertificateInWorkspaceResponseBody
