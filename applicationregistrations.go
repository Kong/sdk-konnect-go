...
func newApplicationRegistrations(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ApplicationRegistrations {
...
func (s *ApplicationRegistrations) ListRegistrations(ctx context.Context, request operations.ListRegistrationsRequest, opts ...operations.Option) (*operations.ListRegistrationsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/portals/{portalId}/application-registrations", request, nil)
	if err != nil {
	...
	res := &operations.ListRegistrationsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListApplicationRegistrationsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListApplicationRegistrationsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *ApplicationRegistrations) CreateApplicationRegistration(ctx context.Context, request operations.CreateApplicationRegistrationRequest, opts ...operations.Option) (*operations.CreateApplicationRegistrationResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetApplicationRegistrationResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *ApplicationRegistrations) ListRegistrationsByApplication(ctx context.Context, request operations.ListRegistrationsByApplicationRequest, opts ...operations.Option) (*operations.ListRegistrationsByApplicationResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.ListRegistrationsByApplicationResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *ApplicationRegistrations) UpdateApplicationRegistrationConsumer(ctx context.Context, request operations.UpdateApplicationRegistrationConsumerRequest, opts ...operations.Option) (*operations.UpdateApplicationRegistrationConsumerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v3/portals/{portalId}/applications/{applicationId}/registrations/{registrationId}/consumer", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "update-application-registration-consumer",
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateRegistrationConsumerRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.UpdateApplicationRegistrationConsumerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *ApplicationRegistrations) DeleteApplicationRegistrationConsumer(ctx context.Context, request operations.DeleteApplicationRegistrationConsumerRequest, opts ...operations.Option) (*operations.DeleteApplicationRegistrationConsumerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "delete-application-registration-consumer",
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.DeleteApplicationRegistrationConsumerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
