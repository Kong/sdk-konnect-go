...
func (s *SystemAccountsTeamMembership) PostTeamsTeamIDSystemAccounts(ctx context.Context, teamID string, addSystemAccountToTeam *components.AddSystemAccountToTeam) (*operations.PostTeamsTeamIDSystemAccountsResponse, error) {
