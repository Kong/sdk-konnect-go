...
type OpenMeterEntitlements struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newOpenMeterEntitlements(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OpenMeterEntitlements {
	return &OpenMeterEntitlements{
		rootSDK:          rootSDK,
...
func (s *OpenMeterEntitlements) ListCustomerEntitlementAccess(ctx context.Context, customerID string, opts ...operations.Option) (*operations.ListCustomerEntitlementAccessResponse, error) {
	request := operations.ListCustomerEntitlementAccessRequest{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			res.ListCustomerEntitlementAccessResponseData = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *OpenMeterEntitlements) GetCustomerEntitlementAccess(ctx context.Context, request operations.GetCustomerEntitlementAccessRequest, opts ...operations.Option) (*operations.GetCustomerEntitlementAccessResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.BillingEntitlementAccessResult
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.BillingEntitlementAccessResult = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
