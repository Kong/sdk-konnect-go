...
func newAPIKeys(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *APIKeys {
	return &APIKeys{
		rootSDK:          rootSDK,
...
func (s *APIKeys) ListKeyAuthWithConsumerInWorkspace(ctx context.Context, request operations.ListKeyAuthWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.ListKeyAuthWithConsumerInWorkspaceResponse, error) {
	...
	res := &operations.ListKeyAuthWithConsumerInWorkspaceResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListKeyAuthWithConsumerInWorkspaceResponseBody
...
func (s *APIKeys) UpsertKeyAuthWithConsumerInWorkspace(ctx context.Context, request operations.UpsertKeyAuthWithConsumerInWorkspaceRequest, opts ...operations.Option) (*operations.UpsertKeyAuthWithConsumerInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.UpsertKeyAuthWithConsumerInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *APIKeys) ListKeyAuthInWorkspace(ctx context.Context, request operations.ListKeyAuthInWorkspaceRequest, opts ...operations.Option) (*operations.ListKeyAuthInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/key-auths", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListKeyAuthInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListKeyAuthInWorkspaceResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *APIKeys) GetKeyAuthInWorkspace(ctx context.Context, request operations.GetKeyAuthInWorkspaceRequest, opts ...operations.Option) (*operations.GetKeyAuthInWorkspaceResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/control-planes/{controlPlaneId}/core-entities/{workspace}/key-auths/{KeyAuthId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetKeyAuthInWorkspaceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
